const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./cssMode-BpIoQ0VB.js","./editor.api2-Cae6yJa1.js","./editor-CGi5ri4_.css","./workers-ph0yO_5T.js","./jsonMode-G7jTcN07.js","./tsMode-TmqFBvWz.js","./freemarker2-C87omYzf.js","./handlebars-BmOs47lF.js","./html-BhDxxfr3.js","./javascript-C7IE-S-q.js","./typescript-BrPls_Ik.js","./liquid-bnqUYpcN.js","./mdx-BJkWgdqb.js","./python-2hwrtfwb.js","./razor-DO8Mt_vd.js","./xml-OXoZ1_1I.js","./yaml-BiLv_8G4.js"])))=>i.map(i=>d[i]);
import{a as e,c as t,i as n,l as r,n as i,o as a,r as o,s,t as c,u as l}from"./editor.api2-Cae6yJa1.js";import{t as u}from"./workers-ph0yO_5T.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var d=`modulepreload`,ee=function(e,t){return new URL(e,t).href},te={},f=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=ee(t,n),t in te)return;te[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``;if(n)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let o=document.createElement(`link`);if(o.rel=r?`stylesheet`:d,r||(o.as=`script`),o.crossOrigin=``,o.href=t,a&&o.setAttribute(`nonce`,a),document.head.appendChild(o),r)return new Promise((e,n)=>{o.addEventListener(`load`,e),o.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},ne=l({cssDefaults:()=>ae,lessDefaults:()=>se,scssDefaults:()=>oe}),p=class{constructor(e,t,n){this._onDidChange=new c,this._languageId=e,this.setOptions(t),this.setModeConfiguration(n)}get onDidChange(){return this._onDidChange.event}get languageId(){return this._languageId}get modeConfiguration(){return this._modeConfiguration}get diagnosticsOptions(){return this.options}get options(){return this._options}setOptions(e){this._options=e||Object.create(null),this._onDidChange.fire(this)}setDiagnosticsOptions(e){this.setOptions(e)}setModeConfiguration(e){this._modeConfiguration=e||Object.create(null),this._onDidChange.fire(this)}},re={validate:!0,lint:{compatibleVendorPrefixes:`ignore`,vendorPrefix:`warning`,duplicateProperties:`warning`,emptyRules:`warning`,importStatement:`ignore`,boxModel:`ignore`,universalSelector:`ignore`,zeroUnits:`ignore`,fontFaceProperties:`warning`,hexColorLength:`error`,argumentsInColorFunction:`error`,unknownProperties:`warning`,ieHack:`ignore`,unknownVendorSpecificProperties:`ignore`,propertyIgnoredDueToDisplay:`warning`,important:`ignore`,float:`ignore`,idSelector:`ignore`},data:{useDefaultDataProvider:!0},format:{newlineBetweenSelectors:!0,newlineBetweenRules:!0,spaceAroundSelectorSeparator:!1,braceStyle:`collapse`,maxPreserveNewLines:void 0,preserveNewLines:!0}},ie={completionItems:!0,hovers:!0,documentSymbols:!0,definitions:!0,references:!0,documentHighlights:!0,rename:!0,colors:!0,foldingRanges:!0,diagnostics:!0,selectionRanges:!0,documentFormattingEdits:!0,documentRangeFormattingEdits:!0},ae=new p(`css`,re,ie),oe=new p(`scss`,re,ie),se=new p(`less`,re,ie);function ce(){return f(()=>import(`./cssMode-BpIoQ0VB.js`),__vite__mapDeps([0,1,2,3]),import.meta.url)}t.onLanguage(`less`,()=>{ce().then(e=>e.setupMode(se))}),t.onLanguage(`scss`,()=>{ce().then(e=>e.setupMode(oe))}),t.onLanguage(`css`,()=>{ce().then(e=>e.setupMode(ae))});var le=l({handlebarDefaults:()=>ge,handlebarLanguageService:()=>he,htmlDefaults:()=>me,htmlLanguageService:()=>pe,razorDefaults:()=>ve,razorLanguageService:()=>_e,registerHTMLLanguageService:()=>_}),ue=class{constructor(e,t,n){this._onDidChange=new c,this._languageId=e,this.setOptions(t),this.setModeConfiguration(n)}get onDidChange(){return this._onDidChange.event}get languageId(){return this._languageId}get options(){return this._options}get modeConfiguration(){return this._modeConfiguration}setOptions(e){this._options=e||Object.create(null),this._onDidChange.fire(this)}setModeConfiguration(e){this._modeConfiguration=e||Object.create(null),this._onDidChange.fire(this)}},m={format:{tabSize:4,insertSpaces:!1,wrapLineLength:120,unformatted:`default": "a, abbr, acronym, b, bdo, big, br, button, cite, code, dfn, em, i, img, input, kbd, label, map, object, q, samp, select, small, span, strong, sub, sup, textarea, tt, var`,contentUnformatted:`pre`,indentInnerHtml:!1,preserveNewLines:!0,maxPreserveNewLines:void 0,indentHandlebars:!1,endWithNewline:!1,extraLiners:`head, body, /html`,wrapAttributes:`auto`},suggest:{},data:{useDefaultDataProvider:!0}};function h(e){return{completionItems:!0,hovers:!0,documentSymbols:!0,links:!0,documentHighlights:!0,rename:!0,colors:!0,foldingRanges:!0,selectionRanges:!0,diagnostics:e===g,documentFormattingEdits:e===g,documentRangeFormattingEdits:e===g}}var g=`html`,de=`handlebars`,fe=`razor`,pe=_(g,m,h(g)),me=pe.defaults,he=_(de,m,h(de)),ge=he.defaults,_e=_(fe,m,h(fe)),ve=_e.defaults;function ye(){return f(()=>import(`./htmlMode-CJF_vH-_.js`),[],import.meta.url)}function _(e,n=m,r=h(e)){let i=new ue(e,n,r),a,o=t.onLanguage(e,async()=>{a=(await ye()).setupMode(i)});return{defaults:i,dispose(){o.dispose(),a?.dispose(),a=void 0}}}var be=l({getWorker:()=>Se,jsonDefaults:()=>xe}),xe=new class{constructor(e,t,n){this._onDidChange=new c,this._languageId=e,this.setDiagnosticsOptions(t),this.setModeConfiguration(n)}get onDidChange(){return this._onDidChange.event}get languageId(){return this._languageId}get modeConfiguration(){return this._modeConfiguration}get diagnosticsOptions(){return this._diagnosticsOptions}setDiagnosticsOptions(e){this._diagnosticsOptions=e||Object.create(null),this._onDidChange.fire(this)}setModeConfiguration(e){this._modeConfiguration=e||Object.create(null),this._onDidChange.fire(this)}}(`json`,{validate:!0,allowComments:!0,schemas:[],enableSchemaRequest:!1,schemaRequest:`warning`,schemaValidation:`warning`,comments:`error`,trailingCommas:`error`},{documentFormattingEdits:!0,documentRangeFormattingEdits:!0,completionItems:!0,hovers:!0,documentSymbols:!0,tokens:!0,colors:!0,foldingRanges:!0,diagnostics:!0,selectionRanges:!0}),Se=()=>Ce().then(e=>e.getWorker());function Ce(){return f(()=>import(`./jsonMode-G7jTcN07.js`),__vite__mapDeps([4,1,2,3]),import.meta.url)}t.register({id:`json`,extensions:[`.json`,`.bowerrc`,`.jshintrc`,`.jscsrc`,`.eslintrc`,`.babelrc`,`.har`],aliases:[`JSON`,`json`],mimetypes:[`application/json`]}),t.onLanguage(`json`,()=>{Ce().then(e=>e.setupMode(xe))});var we=`5.9.3`,Te=l({JsxEmit:()=>De,ModuleKind:()=>Ee,ModuleResolutionKind:()=>Ae,NewLineKind:()=>Oe,ScriptTarget:()=>ke,getJavaScriptWorker:()=>Ie,getTypeScriptWorker:()=>Fe,javascriptDefaults:()=>Pe,typescriptDefaults:()=>v,typescriptVersion:()=>Me}),Ee=(e=>(e[e.None=0]=`None`,e[e.CommonJS=1]=`CommonJS`,e[e.AMD=2]=`AMD`,e[e.UMD=3]=`UMD`,e[e.System=4]=`System`,e[e.ES2015=5]=`ES2015`,e[e.ESNext=99]=`ESNext`,e))(Ee||{}),De=(e=>(e[e.None=0]=`None`,e[e.Preserve=1]=`Preserve`,e[e.React=2]=`React`,e[e.ReactNative=3]=`ReactNative`,e[e.ReactJSX=4]=`ReactJSX`,e[e.ReactJSXDev=5]=`ReactJSXDev`,e))(De||{}),Oe=(e=>(e[e.CarriageReturnLineFeed=0]=`CarriageReturnLineFeed`,e[e.LineFeed=1]=`LineFeed`,e))(Oe||{}),ke=(e=>(e[e.ES3=0]=`ES3`,e[e.ES5=1]=`ES5`,e[e.ES2015=2]=`ES2015`,e[e.ES2016=3]=`ES2016`,e[e.ES2017=4]=`ES2017`,e[e.ES2018=5]=`ES2018`,e[e.ES2019=6]=`ES2019`,e[e.ES2020=7]=`ES2020`,e[e.ESNext=99]=`ESNext`,e[e.JSON=100]=`JSON`,e[e.Latest=99]=`Latest`,e))(ke||{}),Ae=(e=>(e[e.Classic=1]=`Classic`,e[e.NodeJs=2]=`NodeJs`,e))(Ae||{}),je=class{constructor(e,t,n,r,i){this._onDidChange=new c,this._onDidExtraLibsChange=new c,this._extraLibs=Object.create(null),this._removedExtraLibs=Object.create(null),this._eagerModelSync=!1,this.setCompilerOptions(e),this.setDiagnosticsOptions(t),this.setWorkerOptions(n),this.setInlayHintsOptions(r),this.setModeConfiguration(i),this._onDidExtraLibsChangeTimeout=-1}get onDidChange(){return this._onDidChange.event}get onDidExtraLibsChange(){return this._onDidExtraLibsChange.event}get modeConfiguration(){return this._modeConfiguration}get workerOptions(){return this._workerOptions}get inlayHintsOptions(){return this._inlayHintsOptions}getExtraLibs(){return this._extraLibs}addExtraLib(e,t){let n;if(n=t===void 0?`ts:extralib-${Math.random().toString(36).substring(2,15)}`:t,this._extraLibs[n]&&this._extraLibs[n].content===e)return{dispose:()=>{}};let r=1;return this._removedExtraLibs[n]&&(r=this._removedExtraLibs[n]+1),this._extraLibs[n]&&(r=this._extraLibs[n].version+1),this._extraLibs[n]={content:e,version:r},this._fireOnDidExtraLibsChangeSoon(),{dispose:()=>{let e=this._extraLibs[n];e&&e.version===r&&(delete this._extraLibs[n],this._removedExtraLibs[n]=r,this._fireOnDidExtraLibsChangeSoon())}}}setExtraLibs(e){for(let e in this._extraLibs)this._removedExtraLibs[e]=this._extraLibs[e].version;if(this._extraLibs=Object.create(null),e&&e.length>0)for(let t of e){let e=t.filePath||`ts:extralib-${Math.random().toString(36).substring(2,15)}`,n=t.content,r=1;this._removedExtraLibs[e]&&(r=this._removedExtraLibs[e]+1),this._extraLibs[e]={content:n,version:r}}this._fireOnDidExtraLibsChangeSoon()}_fireOnDidExtraLibsChangeSoon(){this._onDidExtraLibsChangeTimeout===-1&&(this._onDidExtraLibsChangeTimeout=window.setTimeout(()=>{this._onDidExtraLibsChangeTimeout=-1,this._onDidExtraLibsChange.fire(void 0)},0))}getCompilerOptions(){return this._compilerOptions}setCompilerOptions(e){this._compilerOptions=e||Object.create(null),this._onDidChange.fire(void 0)}getDiagnosticsOptions(){return this._diagnosticsOptions}setDiagnosticsOptions(e){this._diagnosticsOptions=e||Object.create(null),this._onDidChange.fire(void 0)}setWorkerOptions(e){this._workerOptions=e||Object.create(null),this._onDidChange.fire(void 0)}setInlayHintsOptions(e){this._inlayHintsOptions=e||Object.create(null),this._onDidChange.fire(void 0)}setMaximumWorkerIdleTime(e){}setEagerModelSync(e){this._eagerModelSync=e}getEagerModelSync(){return this._eagerModelSync}setModeConfiguration(e){this._modeConfiguration=e||Object.create(null),this._onDidChange.fire(void 0)}},Me=we,Ne={completionItems:!0,hovers:!0,documentSymbols:!0,definitions:!0,references:!0,documentHighlights:!0,rename:!0,diagnostics:!0,documentRangeFormattingEdits:!0,signatureHelp:!0,onTypeFormattingEdits:!0,codeActions:!0,inlayHints:!0},v=new je({allowNonTsExtensions:!0,target:99},{noSemanticValidation:!1,noSyntaxValidation:!1,onlyVisible:!1},{},{},Ne),Pe=new je({allowNonTsExtensions:!0,allowJs:!0,target:99},{noSemanticValidation:!0,noSyntaxValidation:!1,onlyVisible:!1},{},{},Ne),Fe=()=>y().then(e=>e.getTypeScriptWorker()),Ie=()=>y().then(e=>e.getJavaScriptWorker());function y(){return f(()=>import(`./tsMode-TmqFBvWz.js`),__vite__mapDeps([5,1,2]),import.meta.url)}t.onLanguage(`typescript`,()=>y().then(e=>e.setupTypeScript(v))),t.onLanguage(`javascript`,()=>y().then(e=>e.setupJavaScript(Pe)));var Le={},Re={},ze=class e{static getOrCreate(t){return Re[t]||(Re[t]=new e(t)),Re[t]}constructor(e){this._languageId=e,this._loadingTriggered=!1,this._lazyLoadPromise=new Promise((e,t)=>{this._lazyLoadPromiseResolve=e,this._lazyLoadPromiseReject=t})}load(){return this._loadingTriggered||(this._loadingTriggered=!0,Le[this._languageId].loader().then(e=>this._lazyLoadPromiseResolve(e),e=>this._lazyLoadPromiseReject(e))),this._lazyLoadPromise}};function b(e){let n=e.id;Le[n]=e,t.register(e);let r=ze.getOrCreate(n);t.registerTokensProviderFactory(n,{create:async()=>(await r.load()).language}),t.onLanguageEncountered(n,async()=>{let e=await r.load();t.setLanguageConfiguration(n,e.conf)})}b({id:`abap`,extensions:[`.abap`],aliases:[`abap`,`ABAP`],loader:()=>f(()=>import(`./abap-BRVHlTbR.js`),[],import.meta.url)}),b({id:`apex`,extensions:[`.cls`],aliases:[`Apex`,`apex`],mimetypes:[`text/x-apex-source`,`text/x-apex`],loader:()=>f(()=>import(`./apex-GS4zZi0I.js`),[],import.meta.url)}),b({id:`azcli`,extensions:[`.azcli`],aliases:[`Azure CLI`,`azcli`],loader:()=>f(()=>import(`./azcli-TAZdLe_1.js`),[],import.meta.url)}),b({id:`bat`,extensions:[`.bat`,`.cmd`],aliases:[`Batch`,`bat`],loader:()=>f(()=>import(`./bat-BNHAuPwR.js`),[],import.meta.url)}),b({id:`bicep`,extensions:[`.bicep`],aliases:[`Bicep`],loader:()=>f(()=>import(`./bicep-BAoj49ib.js`),[],import.meta.url)}),b({id:`cameligo`,extensions:[`.mligo`],aliases:[`Cameligo`],loader:()=>f(()=>import(`./cameligo-gupdI4nQ.js`),[],import.meta.url)}),b({id:`clojure`,extensions:[`.clj`,`.cljs`,`.cljc`,`.edn`],aliases:[`clojure`,`Clojure`],loader:()=>f(()=>import(`./clojure-Bfa7OrL3.js`),[],import.meta.url)}),b({id:`coffeescript`,extensions:[`.coffee`],aliases:[`CoffeeScript`,`coffeescript`,`coffee`],mimetypes:[`text/x-coffeescript`,`text/coffeescript`],loader:()=>f(()=>import(`./coffee-B0FZSSpt.js`),[],import.meta.url)}),b({id:`c`,extensions:[`.c`,`.h`],aliases:[`C`,`c`],loader:()=>f(()=>import(`./cpp-_-gj_ws2.js`),[],import.meta.url)}),b({id:`cpp`,extensions:[`.cpp`,`.cc`,`.cxx`,`.hpp`,`.hh`,`.hxx`],aliases:[`C++`,`Cpp`,`cpp`],loader:()=>f(()=>import(`./cpp-_-gj_ws2.js`),[],import.meta.url)}),b({id:`csharp`,extensions:[`.cs`,`.csx`,`.cake`],aliases:[`C#`,`csharp`],loader:()=>f(()=>import(`./csharp-BlRNCFE9.js`),[],import.meta.url)}),b({id:`csp`,extensions:[`.csp`],aliases:[`CSP`,`csp`],loader:()=>f(()=>import(`./csp-B2Z5Y_Sf.js`),[],import.meta.url)}),b({id:`css`,extensions:[`.css`],aliases:[`CSS`,`css`],mimetypes:[`text/css`],loader:()=>f(()=>import(`./css-BmeubtOS.js`),[],import.meta.url)}),b({id:`cypher`,extensions:[`.cypher`,`.cyp`],aliases:[`Cypher`,`OpenCypher`],loader:()=>f(()=>import(`./cypher-PFHDKyaL.js`),[],import.meta.url)}),b({id:`dart`,extensions:[`.dart`],aliases:[`Dart`,`dart`],mimetypes:[`text/x-dart-source`,`text/x-dart`],loader:()=>f(()=>import(`./dart-BwvfliPc.js`),[],import.meta.url)}),b({id:`dockerfile`,extensions:[`.dockerfile`],filenames:[`Dockerfile`],aliases:[`Dockerfile`],loader:()=>f(()=>import(`./dockerfile-Y-SfPMKb.js`),[],import.meta.url)}),b({id:`ecl`,extensions:[`.ecl`],aliases:[`ECL`,`Ecl`,`ecl`],loader:()=>f(()=>import(`./ecl-BLLFWuTF.js`),[],import.meta.url)}),b({id:`elixir`,extensions:[`.ex`,`.exs`],aliases:[`Elixir`,`elixir`,`ex`],loader:()=>f(()=>import(`./elixir-xXCAglHV.js`),[],import.meta.url)}),b({id:`flow9`,extensions:[`.flow`],aliases:[`Flow9`,`Flow`,`flow9`,`flow`],loader:()=>f(()=>import(`./flow9-CVf6ZIck.js`),[],import.meta.url)}),b({id:`fsharp`,extensions:[`.fs`,`.fsi`,`.ml`,`.mli`,`.fsx`,`.fsscript`],aliases:[`F#`,`FSharp`,`fsharp`],loader:()=>f(()=>import(`./fsharp-BQqR9uQ6.js`),[],import.meta.url)}),b({id:`freemarker2`,extensions:[`.ftl`,`.ftlh`,`.ftlx`],aliases:[`FreeMarker2`,`Apache FreeMarker2`],loader:()=>f(()=>import(`./freemarker2-C87omYzf.js`).then(e=>e.TagAutoInterpolationDollar),__vite__mapDeps([6,1,2]),import.meta.url)}),b({id:`freemarker2.tag-angle.interpolation-dollar`,aliases:[`FreeMarker2 (Angle/Dollar)`,`Apache FreeMarker2 (Angle/Dollar)`],loader:()=>f(()=>import(`./freemarker2-C87omYzf.js`).then(e=>e.TagAngleInterpolationDollar),__vite__mapDeps([6,1,2]),import.meta.url)}),b({id:`freemarker2.tag-bracket.interpolation-dollar`,aliases:[`FreeMarker2 (Bracket/Dollar)`,`Apache FreeMarker2 (Bracket/Dollar)`],loader:()=>f(()=>import(`./freemarker2-C87omYzf.js`).then(e=>e.TagBracketInterpolationDollar),__vite__mapDeps([6,1,2]),import.meta.url)}),b({id:`freemarker2.tag-angle.interpolation-bracket`,aliases:[`FreeMarker2 (Angle/Bracket)`,`Apache FreeMarker2 (Angle/Bracket)`],loader:()=>f(()=>import(`./freemarker2-C87omYzf.js`).then(e=>e.TagAngleInterpolationBracket),__vite__mapDeps([6,1,2]),import.meta.url)}),b({id:`freemarker2.tag-bracket.interpolation-bracket`,aliases:[`FreeMarker2 (Bracket/Bracket)`,`Apache FreeMarker2 (Bracket/Bracket)`],loader:()=>f(()=>import(`./freemarker2-C87omYzf.js`).then(e=>e.TagBracketInterpolationBracket),__vite__mapDeps([6,1,2]),import.meta.url)}),b({id:`freemarker2.tag-auto.interpolation-dollar`,aliases:[`FreeMarker2 (Auto/Dollar)`,`Apache FreeMarker2 (Auto/Dollar)`],loader:()=>f(()=>import(`./freemarker2-C87omYzf.js`).then(e=>e.TagAutoInterpolationDollar),__vite__mapDeps([6,1,2]),import.meta.url)}),b({id:`freemarker2.tag-auto.interpolation-bracket`,aliases:[`FreeMarker2 (Auto/Bracket)`,`Apache FreeMarker2 (Auto/Bracket)`],loader:()=>f(()=>import(`./freemarker2-C87omYzf.js`).then(e=>e.TagAutoInterpolationBracket),__vite__mapDeps([6,1,2]),import.meta.url)}),b({id:`go`,extensions:[`.go`],aliases:[`Go`],loader:()=>f(()=>import(`./go-C3AlMVwy.js`),[],import.meta.url)}),b({id:`graphql`,extensions:[`.graphql`,`.gql`],aliases:[`GraphQL`,`graphql`,`gql`],mimetypes:[`application/graphql`],loader:()=>f(()=>import(`./graphql-O_-hDldf.js`),[],import.meta.url)}),b({id:`handlebars`,extensions:[`.handlebars`,`.hbs`],aliases:[`Handlebars`,`handlebars`,`hbs`],mimetypes:[`text/x-handlebars-template`],loader:()=>f(()=>import(`./handlebars-BmOs47lF.js`),__vite__mapDeps([7,1,2]),import.meta.url)}),b({id:`hcl`,extensions:[`.tf`,`.tfvars`,`.hcl`],aliases:[`Terraform`,`tf`,`HCL`,`hcl`],loader:()=>f(()=>import(`./hcl-BQQD6Mtj.js`),[],import.meta.url)}),b({id:`html`,extensions:[`.html`,`.htm`,`.shtml`,`.xhtml`,`.mdoc`,`.jsp`,`.asp`,`.aspx`,`.jshtm`],aliases:[`HTML`,`htm`,`html`,`xhtml`],mimetypes:[`text/html`,`text/x-jshtm`,`text/template`,`text/ng-template`],loader:()=>f(()=>import(`./html-BhDxxfr3.js`),__vite__mapDeps([8,1,2]),import.meta.url)}),b({id:`ini`,extensions:[`.ini`,`.properties`,`.gitconfig`],filenames:[`config`,`.gitattributes`,`.gitconfig`,`.editorconfig`],aliases:[`Ini`,`ini`],loader:()=>f(()=>import(`./ini-Bf0RDfP_.js`),[],import.meta.url)}),b({id:`java`,extensions:[`.java`,`.jav`],aliases:[`Java`,`java`],mimetypes:[`text/x-java-source`,`text/x-java`],loader:()=>f(()=>import(`./java-nqX2KEDD.js`),[],import.meta.url)}),b({id:`javascript`,extensions:[`.js`,`.es6`,`.jsx`,`.mjs`,`.cjs`],firstLine:`^#!.*\\bnode`,filenames:[`jakefile`],aliases:[`JavaScript`,`javascript`,`js`],mimetypes:[`text/javascript`],loader:()=>f(()=>import(`./javascript-C7IE-S-q.js`),__vite__mapDeps([9,10,1,2]),import.meta.url)}),b({id:`julia`,extensions:[`.jl`],aliases:[`julia`,`Julia`],loader:()=>f(()=>import(`./julia-B6P9U5er.js`),[],import.meta.url)}),b({id:`kotlin`,extensions:[`.kt`,`.kts`],aliases:[`Kotlin`,`kotlin`],mimetypes:[`text/x-kotlin-source`,`text/x-kotlin`],loader:()=>f(()=>import(`./kotlin-iQmfEFdy.js`),[],import.meta.url)}),b({id:`less`,extensions:[`.less`],aliases:[`Less`,`less`],mimetypes:[`text/x-less`,`text/less`],loader:()=>f(()=>import(`./less-CEaIdW1f.js`),[],import.meta.url)}),b({id:`lexon`,extensions:[`.lex`],aliases:[`Lexon`],loader:()=>f(()=>import(`./lexon-Qv4pvFSW.js`),[],import.meta.url)}),b({id:`lua`,extensions:[`.lua`],aliases:[`Lua`,`lua`],loader:()=>f(()=>import(`./lua-CFpyR7YN.js`),[],import.meta.url)}),b({id:`liquid`,extensions:[`.liquid`,`.html.liquid`],aliases:[`Liquid`,`liquid`],mimetypes:[`application/liquid`],loader:()=>f(()=>import(`./liquid-bnqUYpcN.js`),__vite__mapDeps([11,1,2]),import.meta.url)}),b({id:`m3`,extensions:[`.m3`,`.i3`,`.mg`,`.ig`],aliases:[`Modula-3`,`Modula3`,`modula3`,`m3`],loader:()=>f(()=>import(`./m3-CvKhVPQn.js`),[],import.meta.url)}),b({id:`markdown`,extensions:[`.md`,`.markdown`,`.mdown`,`.mkdn`,`.mkd`,`.mdwn`,`.mdtxt`,`.mdtext`],aliases:[`Markdown`,`markdown`],loader:()=>f(()=>import(`./markdown-qldG3Vc4.js`),[],import.meta.url)}),b({id:`mdx`,extensions:[`.mdx`],aliases:[`MDX`,`mdx`],loader:()=>f(()=>import(`./mdx-BJkWgdqb.js`),__vite__mapDeps([12,1,2]),import.meta.url)}),b({id:`mips`,extensions:[`.s`],aliases:[`MIPS`,`MIPS-V`],mimetypes:[`text/x-mips`,`text/mips`,`text/plaintext`],loader:()=>f(()=>import(`./mips-0D8PRyHq.js`),[],import.meta.url)}),b({id:`msdax`,extensions:[`.dax`,`.msdax`],aliases:[`DAX`,`MSDAX`],loader:()=>f(()=>import(`./msdax-DwZXSC5M.js`),[],import.meta.url)}),b({id:`mysql`,extensions:[],aliases:[`MySQL`,`mysql`],loader:()=>f(()=>import(`./mysql-BWq85KY4.js`),[],import.meta.url)}),b({id:`objective-c`,extensions:[`.m`],aliases:[`Objective-C`],loader:()=>f(()=>import(`./objective-c-D653JUMG.js`),[],import.meta.url)}),b({id:`pascal`,extensions:[`.pas`,`.p`,`.pp`],aliases:[`Pascal`,`pas`],mimetypes:[`text/x-pascal-source`,`text/x-pascal`],loader:()=>f(()=>import(`./pascal-rWjRDdnR.js`),[],import.meta.url)}),b({id:`pascaligo`,extensions:[`.ligo`],aliases:[`Pascaligo`,`ligo`],loader:()=>f(()=>import(`./pascaligo-Db8EehaF.js`),[],import.meta.url)}),b({id:`perl`,extensions:[`.pl`,`.pm`],aliases:[`Perl`,`pl`],loader:()=>f(()=>import(`./perl-C68oq8-D.js`),[],import.meta.url)}),b({id:`pgsql`,extensions:[],aliases:[`PostgreSQL`,`postgres`,`pg`,`postgre`],loader:()=>f(()=>import(`./pgsql-BXeHe33s.js`),[],import.meta.url)}),b({id:`php`,extensions:[`.php`,`.php4`,`.php5`,`.phtml`,`.ctp`],aliases:[`PHP`,`php`],mimetypes:[`application/x-php`],loader:()=>f(()=>import(`./php-CDVsAbfl.js`),[],import.meta.url)}),b({id:`pla`,extensions:[`.pla`],loader:()=>f(()=>import(`./pla-DnryFT0q.js`),[],import.meta.url)}),b({id:`postiats`,extensions:[`.dats`,`.sats`,`.hats`],aliases:[`ATS`,`ATS/Postiats`],loader:()=>f(()=>import(`./postiats-CDg_4Ev-.js`),[],import.meta.url)}),b({id:`powerquery`,extensions:[`.pq`,`.pqm`],aliases:[`PQ`,`M`,`Power Query`,`Power Query M`],loader:()=>f(()=>import(`./powerquery-CWPi8ROz.js`),[],import.meta.url)}),b({id:`powershell`,extensions:[`.ps1`,`.psm1`,`.psd1`],aliases:[`PowerShell`,`powershell`,`ps`,`ps1`],loader:()=>f(()=>import(`./powershell-C5A0QX3-.js`),[],import.meta.url)}),b({id:`proto`,extensions:[`.proto`],aliases:[`protobuf`,`Protocol Buffers`],loader:()=>f(()=>import(`./protobuf-Cgt-BQbL.js`),[],import.meta.url)}),b({id:`pug`,extensions:[`.jade`,`.pug`],aliases:[`Pug`,`Jade`,`jade`],loader:()=>f(()=>import(`./pug-RPYJC9QB.js`),[],import.meta.url)}),b({id:`python`,extensions:[`.py`,`.rpy`,`.pyw`,`.cpy`,`.gyp`,`.gypi`],aliases:[`Python`,`py`],firstLine:`^#!/.*\\bpython[0-9.-]*\\b`,loader:()=>f(()=>import(`./python-2hwrtfwb.js`),__vite__mapDeps([13,1,2]),import.meta.url)}),b({id:`qsharp`,extensions:[`.qs`],aliases:[`Q#`,`qsharp`],loader:()=>f(()=>import(`./qsharp-CEz_fZTu.js`),[],import.meta.url)}),b({id:`r`,extensions:[`.r`,`.rhistory`,`.rmd`,`.rprofile`,`.rt`],aliases:[`R`,`r`],loader:()=>f(()=>import(`./r-CN875f1X.js`),[],import.meta.url)}),b({id:`razor`,extensions:[`.cshtml`],aliases:[`Razor`,`razor`],mimetypes:[`text/x-cshtml`],loader:()=>f(()=>import(`./razor-DO8Mt_vd.js`),__vite__mapDeps([14,1,2]),import.meta.url)}),b({id:`redis`,extensions:[`.redis`],aliases:[`redis`],loader:()=>f(()=>import(`./redis-BLesvTwR.js`),[],import.meta.url)}),b({id:`redshift`,extensions:[],aliases:[`Redshift`,`redshift`],loader:()=>f(()=>import(`./redshift-Byf_0XqD.js`),[],import.meta.url)}),b({id:`restructuredtext`,extensions:[`.rst`],aliases:[`reStructuredText`,`restructuredtext`],loader:()=>f(()=>import(`./restructuredtext-DYg_6BiZ.js`),[],import.meta.url)}),b({id:`ruby`,extensions:[`.rb`,`.rbx`,`.rjs`,`.gemspec`,`.pp`],filenames:[`rakefile`,`Gemfile`],aliases:[`Ruby`,`rb`],loader:()=>f(()=>import(`./ruby-C4OkxbC-.js`),[],import.meta.url)}),b({id:`rust`,extensions:[`.rs`,`.rlib`],aliases:[`Rust`,`rust`],loader:()=>f(()=>import(`./rust-xAoaEFMh.js`),[],import.meta.url)}),b({id:`sb`,extensions:[`.sb`],aliases:[`Small Basic`,`sb`],loader:()=>f(()=>import(`./sb-C8dHOW_y.js`),[],import.meta.url)}),b({id:`scala`,extensions:[`.scala`,`.sc`,`.sbt`],aliases:[`Scala`,`scala`,`SBT`,`Sbt`,`sbt`,`Dotty`,`dotty`],mimetypes:[`text/x-scala-source`,`text/x-scala`,`text/x-sbt`,`text/x-dotty`],loader:()=>f(()=>import(`./scala-Spx0wP1o.js`),[],import.meta.url)}),b({id:`scheme`,extensions:[`.scm`,`.ss`,`.sch`,`.rkt`],aliases:[`scheme`,`Scheme`],loader:()=>f(()=>import(`./scheme-D2mZlAUz.js`),[],import.meta.url)}),b({id:`scss`,extensions:[`.scss`],aliases:[`Sass`,`sass`,`scss`],mimetypes:[`text/x-scss`,`text/scss`],loader:()=>f(()=>import(`./scss-DDCn3Ylu.js`),[],import.meta.url)}),b({id:`shell`,extensions:[`.sh`,`.bash`],aliases:[`Shell`,`sh`],loader:()=>f(()=>import(`./shell-M6px0EWn.js`),[],import.meta.url)}),b({id:`sol`,extensions:[`.sol`],aliases:[`sol`,`solidity`,`Solidity`],loader:()=>f(()=>import(`./solidity-DUWMJi-f.js`),[],import.meta.url)}),b({id:`aes`,extensions:[`.aes`],aliases:[`aes`,`sophia`,`Sophia`],loader:()=>f(()=>import(`./sophia-DwJbUG-2.js`),[],import.meta.url)}),b({id:`sparql`,extensions:[`.rq`],aliases:[`sparql`,`SPARQL`],loader:()=>f(()=>import(`./sparql-ClQxbRPI.js`),[],import.meta.url)}),b({id:`sql`,extensions:[`.sql`],aliases:[`SQL`],loader:()=>f(()=>import(`./sql-BQdjW7Vy.js`),[],import.meta.url)}),b({id:`st`,extensions:[`.st`,`.iecst`,`.iecplc`,`.lc3lib`,`.TcPOU`,`.TcDUT`,`.TcGVL`,`.TcIO`],aliases:[`StructuredText`,`scl`,`stl`],loader:()=>f(()=>import(`./st-BpISyZ_v.js`),[],import.meta.url)}),b({id:`swift`,aliases:[`Swift`,`swift`],extensions:[`.swift`],mimetypes:[`text/swift`],loader:()=>f(()=>import(`./swift-CMbl5gM4.js`),[],import.meta.url)}),b({id:`systemverilog`,extensions:[`.sv`,`.svh`],aliases:[`SV`,`sv`,`SystemVerilog`,`systemverilog`],loader:()=>f(()=>import(`./systemverilog-jx2Xs7uO.js`),[],import.meta.url)}),b({id:`verilog`,extensions:[`.v`,`.vh`],aliases:[`V`,`v`,`Verilog`,`verilog`],loader:()=>f(()=>import(`./systemverilog-jx2Xs7uO.js`),[],import.meta.url)}),b({id:`tcl`,extensions:[`.tcl`],aliases:[`tcl`,`Tcl`,`tcltk`,`TclTk`,`tcl/tk`,`Tcl/Tk`],loader:()=>f(()=>import(`./tcl-GIGnfs89.js`),[],import.meta.url)}),b({id:`twig`,extensions:[`.twig`],aliases:[`Twig`,`twig`],mimetypes:[`text/x-twig`],loader:()=>f(()=>import(`./twig-Bc0mxc_m.js`),[],import.meta.url)}),b({id:`typescript`,extensions:[`.ts`,`.tsx`,`.cts`,`.mts`],aliases:[`TypeScript`,`ts`,`typescript`],mimetypes:[`text/typescript`],loader:()=>f(()=>import(`./typescript-BrPls_Ik.js`),__vite__mapDeps([10,1,2]),import.meta.url)}),b({id:`typespec`,extensions:[`.tsp`],aliases:[`TypeSpec`],loader:()=>f(()=>import(`./typespec-CEioAsEm.js`),[],import.meta.url)}),b({id:`vb`,extensions:[`.vb`],aliases:[`Visual Basic`,`vb`],loader:()=>f(()=>import(`./vb-BPk67J-d.js`),[],import.meta.url)}),b({id:`wgsl`,extensions:[`.wgsl`],aliases:[`WebGPU Shading Language`,`WGSL`,`wgsl`],loader:()=>f(()=>import(`./wgsl-DOnyt8_J.js`),[],import.meta.url)}),b({id:`xml`,extensions:[`.xml`,`.xsd`,`.dtd`,`.ascx`,`.csproj`,`.config`,`.props`,`.targets`,`.wxi`,`.wxl`,`.wxs`,`.xaml`,`.svg`,`.svgz`,`.opf`,`.xslt`,`.xsl`],firstLine:`(\\<\\?xml.*)|(\\<svg)|(\\<\\!doctype\\s+svg)`,aliases:[`XML`,`xml`],mimetypes:[`text/xml`,`application/xml`,`application/xaml+xml`,`application/xml-dtd`],loader:()=>f(()=>import(`./xml-OXoZ1_1I.js`),__vite__mapDeps([15,1,2]),import.meta.url)}),b({id:`yaml`,extensions:[`.yaml`,`.yml`],aliases:[`YAML`,`yaml`,`YML`,`yml`],mimetypes:[`application/x-yaml`,`text/x-yaml`],loader:()=>f(()=>import(`./yaml-BiLv_8G4.js`),__vite__mapDeps([16,1,2]),import.meta.url)});var Be=Object.defineProperty,Ve=(e,t,n)=>t in e?Be(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,x=(e,t,n)=>Ve(e,typeof t==`symbol`?t:t+``,n),He,Ue,S,We,C;function Ge(e){return e.method!==void 0}var Ke;(function(e){function t(e){return e}e.create=t})(Ke||={});var w;(function(e){e.parseError=-32700,e.invalidRequest=-32600,e.methodNotFound=-32601,e.invalidParams=-32602,e.internalError=-32603;function t(e){return-32099<=e&&e<=-32e3}e.isServerError=t;function n(e){if(!t(e))throw Error(`Invalid range for a server error.`);return e}e.serverError=n,e.unexpectedServerError=-32e3;function r(e){return!0}e.isApplicationError=r;function i(e){return e}e.applicationError=i,e.genericApplicationError=-320100})(w||={});var qe=class{constructor(){x(this,`listeners`,new Set),x(this,`event`,e=>(this.listeners.add(e),{dispose:()=>{this.listeners.delete(e)}}))}fire(e){this.listeners.forEach(t=>t(e))}},Je=class{constructor(e){x(this,`_value`),x(this,`eventEmitter`),this._value=e,this.eventEmitter=new qe}get value(){return this._value}set value(e){this._value!==e&&(this._value=e,this.eventEmitter.fire(e))}get onChange(){return this.eventEmitter.event}};function Ye(e,t){let n=setTimeout(t,e);return{dispose:()=>clearTimeout(n)}}function Xe(e,t,n){return e instanceof Set?(e.add(t),{dispose:()=>e.delete(t)}):(e.set(t,n),{dispose:()=>e.delete(t)})}var Ze=class{constructor(){x(this,`_state`,`none`),x(this,`promise`),x(this,`resolve`,()=>{}),x(this,`reject`,()=>{}),this.promise=new Promise((e,t)=>{this.resolve=e,this.reject=t})}get state(){return this._state}};He=class{constructor(){x(this,`_unprocessedMessages`,[]),x(this,`_messageListener`),x(this,`id`,He.id++),x(this,`_state`,new Je({state:`open`})),x(this,`state`,this._state)}setListener(e){if(this._messageListener=e,e)for(;this._unprocessedMessages.length>0&&this._messageListener!==void 0;){let e=this._unprocessedMessages.shift();this._messageListener(e)}}send(e){return this._sendImpl(e)}_dispatchReceivedMessage(e){this._unprocessedMessages.length===0&&this._messageListener?this._messageListener(e):this._unprocessedMessages.push(e)}_onConnectionClosed(){this._state.value={state:`closed`,error:void 0}}log(e){return new Qe(this,e??new $e)}},x(He,`id`,0);var Qe=class{constructor(e,t){x(this,`baseStream`),x(this,`logger`),this.baseStream=e,this.logger=t}get state(){return this.baseStream.state}setListener(e){if(e===void 0){this.baseStream.setListener(void 0);return}this.baseStream.setListener(t=>{this.logger.log(this.baseStream,`incoming`,t),e(t)})}send(e){return this.logger.log(this.baseStream,`outgoing`,e),this.baseStream.send(e)}toString(){return`StreamLogger/${this.baseStream.toString()}`}},$e=class{log(e,t,n){console.log(`${t===`incoming`?`<-`:`->`} [${e.toString()}] ${JSON.stringify(n)}`)}},et=class e{constructor(e){x(this,`connect`),this.connect=e}mapContext(t){return new e(e=>this.connect(e?tt(e,t):void 0))}};function tt(e,t){return{handleNotification:(n,r)=>e.handleNotification(n,t(r)),handleRequest:(n,r,i)=>e.handleRequest(n,r,t(i))}}var nt=class e{constructor(e,t,n){x(this,`_stream`),x(this,`_listener`),x(this,`_logger`),x(this,`_unprocessedResponses`,new Map),x(this,`_lastUsedRequestId`,0),this._stream=e,this._listener=t,this._logger=n,this._stream.setListener(e=>{Ge(e)?e.id===void 0?this._processNotification(e):this._processRequest(e):this._processResponse(e)})}static createChannel(t,n){let r=!1;return new et(i=>{if(r)throw Error(`A channel to the stream ${t} was already constructed!`);return r=!0,new e(t,i,n)})}get state(){return this._stream.state}async _processNotification(e){if(e.id!==void 0)throw Error();if(!this._listener){this._logger&&this._logger.debug({text:`Notification ignored`,message:e});return}try{await this._listener.handleNotification({method:e.method,params:e.params||null})}catch(t){this._logger&&this._logger.warn({text:`Exception was thrown while handling notification: ${t}`,exception:t,message:e})}}async _processRequest(e){if(e.id===void 0)throw Error();let t;if(this._listener)try{t=await this._listener.handleRequest({method:e.method,params:e.params||null},e.id)}catch(n){this._logger&&this._logger.warn({text:`Exception was thrown while handling request: ${n}`,message:e,exception:n}),t={error:{code:w.internalError,message:`An unexpected exception was thrown.`,data:void 0}}}else this._logger&&this._logger.debug({text:`Received request even though not listening for requests`,message:e}),t={error:{code:w.methodNotFound,message:`This endpoint does not listen for requests or notifications.`,data:void 0}};let n;n=`result`in t?{jsonrpc:`2.0`,id:e.id,result:t.result}:{jsonrpc:`2.0`,id:e.id,error:t.error},await this._stream.send(n)}_processResponse(e){let t=``+e.id,n=this._unprocessedResponses.get(t);if(!n){this._logger&&this._logger.debug({text:`Got an unexpected response message`,message:e});return}this._unprocessedResponses.delete(t),n(e)}_newRequestId(){return this._lastUsedRequestId++}sendRequest(e,t,n){let r={jsonrpc:`2.0`,id:this._newRequestId(),method:e.method,params:e.params||void 0};return n&&n(r.id),new Promise((e,t)=>{let n=``+r.id;this._unprocessedResponses.set(n,n=>{`result`in n?e({result:n.result}):(n.error||t(Error(`Response had neither 'result' nor 'error' field set.`)),e({error:n.error}))}),this._stream.send(r).then(void 0,e=>{this._unprocessedResponses.delete(n),t(e)})})}sendNotification(e,t){let n={jsonrpc:`2.0`,id:void 0,method:e.method,params:e.params||void 0};return this._stream.send(n)}toString(){return`StreamChannel/`+this._stream.toString()}},T;(function(e){function t(){return{deserializeFromJson:e=>({hasErrors:!1,value:e}),serializeToJson:e=>e}}e.sAny=t;function n(){return{deserializeFromJson:e=>({hasErrors:!1,value:{}}),serializeToJson:e=>({})}}e.sEmptyObject=n;function r(){return{deserializeFromJson:e=>({hasErrors:!1,value:void 0}),serializeToJson:e=>null}}e.sVoidFromNull=r})(T||={});var rt=Symbol(`OptionalMethodNotFound`),it=class{contextualize(e){return new at(this,e)}},at=class extends it{constructor(e,t){super(),x(this,`underylingTypedChannel`),x(this,`converters`),this.underylingTypedChannel=e,this.converters=t}async request(e,t,n){let r=await this.converters.getSendContext(n);return this.underylingTypedChannel.request(e,t,r)}async notify(e,t,n){let r=await this.converters.getSendContext(n);return this.underylingTypedChannel.notify(e,t,r)}registerNotificationHandler(e,t){return this.underylingTypedChannel.registerNotificationHandler(e,async(e,n)=>await t(e,await this.converters.getNewContext(n)))}registerRequestHandler(e,t){return this.underylingTypedChannel.registerRequestHandler(e,async(e,n,r)=>await t(e,n,await this.converters.getNewContext(r)))}},ot=class e extends it{constructor(e,t={}){super(),x(this,`channelCtor`),x(this,`_requestSender`),x(this,`_handler`,new Map),x(this,`_unknownNotificationHandler`,new Set),x(this,`_timeout`),x(this,`sendExceptionDetails`,!1),x(this,`_logger`),x(this,`listeningDeferred`,new Ze),x(this,`onListening`,this.listeningDeferred.promise),x(this,`_requestDidErrorEventEmitter`,new qe),x(this,`onRequestDidError`,this._requestDidErrorEventEmitter.event),this.channelCtor=e,this._logger=t.logger,this.sendExceptionDetails=!!t.sendExceptionDetails,this._timeout=Ye(1e3,()=>{this._requestSender||console.warn(`"${this.startListen.name}" has not been called within 1 second after construction of this channel. Did you forget to call it?`,this)})}static fromTransport(t,n={}){return new e(nt.createChannel(t,n.logger),n)}startListen(){if(this._requestSender)throw Error(`"${this.startListen.name}" can be called only once, but it already has been called.`);this._timeout&&=(this._timeout.dispose(),void 0),this._requestSender=this.channelCtor.connect({handleRequest:(e,t,n)=>this.handleRequest(e,t,n),handleNotification:(e,t)=>this.handleNotification(e,t)}),this.listeningDeferred.resolve()}checkChannel(e){if(!e)throw Error(`"${this.startListen.name}" must be called before any messages can be sent or received.`);return!0}async handleRequest(e,t,n){let r=this._handler.get(e.method);if(!r)return this._logger&&this._logger.debug({text:`No request handler for "${e.method}".`,data:{requestObject:e}}),{error:{code:w.methodNotFound,message:`No request handler for "${e.method}".`,data:{method:e.method}}};if(r.kind!=`request`){let t=`"${e.method}" is registered as notification, but was sent as request.`;return this._logger&&this._logger.debug({text:t,data:{requestObject:e}}),{error:{code:w.invalidRequest,message:t,data:{method:e.method}}}}let i=r.requestType.paramsSerializer.deserializeFromJson(e.params);if(i.hasErrors){let t=`Got invalid params: ${i.errorMessage}`;return this._logger&&this._logger.debug({text:t,data:{requestObject:e,errorMessage:i.errorMessage}}),{error:{code:w.invalidParams,message:t,data:{errors:i.errorMessage}}}}else{let a=i.value,o;try{let e=await r.handler(a,t,n);if(`error`in e||`errorMessage`in e){let t=e.error?r.requestType.errorSerializer.serializeToJson(e.error):void 0;o={error:{code:e.errorCode||w.genericApplicationError,message:e.errorMessage||`An error was returned`,data:t}}}else o={result:r.requestType.resultSerializer.serializeToJson(e.ok)}}catch(t){t instanceof ct?o={error:{code:t.code,message:t.message}}:(this._logger&&this._logger.warn({text:`An exception was thrown while handling a request: ${t}.`,exception:t,data:{requestObject:e}}),o={error:{code:w.unexpectedServerError,message:this.sendExceptionDetails?`An exception was thrown while handling a request: ${t}.`:`Server has thrown an unexpected exception`}})}return o}}async handleNotification(e,t){let n=this._handler.get(e.method);if(!n){for(let t of this._unknownNotificationHandler)t(e);this._unknownNotificationHandler.size===0&&this._logger&&this._logger.debug({text:`Unhandled notification "${e.method}"`,data:{requestObject:e}});return}if(n.kind!=`notification`){this._logger&&this._logger.debug({text:`"${e.method}" is registered as request, but was sent as notification.`,data:{requestObject:e}});return}let r=n.notificationType.paramsSerializer.deserializeFromJson(e.params);if(r.hasErrors){this._logger&&this._logger.debug({text:`Got invalid params: ${r}`,data:{requestObject:e,errorMessage:r.errorMessage}});return}let i=r.value;for(let r of n.handlers)try{r(i,t)}catch(t){this._logger&&this._logger.warn({text:`An exception was thrown while handling a notification: ${t}.`,exception:t,data:{requestObject:e}})}}registerUnknownNotificationHandler(e){return Xe(this._unknownNotificationHandler,e)}registerRequestHandler(e,t){if(this._handler.get(e.method))throw Error(`Handler with method "${e.method}" already registered.`);return Xe(this._handler,e.method,{kind:`request`,requestType:e,handler:t})}registerNotificationHandler(e,t){let n=this._handler.get(e.method);if(!n)n={kind:`notification`,notificationType:e,handlers:new Set},this._handler.set(e.method,n);else{if(n.kind!==`notification`)throw Error(`Method "${e.method}" was already registered as request handler.`);if(n.notificationType!==e)throw Error(`Method "${e.method}" was registered for a different type.`)}return Xe(n.handlers,t)}getRegisteredTypes(){let e=[];for(let t of this._handler.values())t.kind===`notification`?e.push(t.notificationType):t.kind===`request`&&e.push(t.requestType);return e}async request(e,t,n){if(!this.checkChannel(this._requestSender))throw Error(`Impossible`);let r=e.paramsSerializer.serializeToJson(t);st(r);let i=await this._requestSender.sendRequest({method:e.method,params:r},n);if(`error`in i){if(e.isOptional&&i.error.code===w.methodNotFound)return rt;let t;if(i.error.data!==void 0){let n=e.errorSerializer.deserializeFromJson(i.error.data);if(n.hasErrors)throw Error(n.errorMessage);t=n.value}else t=void 0;let n=new ct(i.error.message,t,i.error.code);throw this._requestDidErrorEventEmitter.fire({error:n}),n}else{let t=e.resultSerializer.deserializeFromJson(i.result);if(t.hasErrors)throw Error(`Could not deserialize response: `+t.errorMessage+`

${JSON.stringify(i,null,2)}`);return t.value}}async notify(e,t,n){if(!this.checkChannel(this._requestSender))throw Error();let r=e.paramsSerializer.serializeToJson(t);st(r),this._requestSender.sendNotification({method:e.method,params:r},n)}};function st(e){if(e!==null&&Array.isArray(e)&&typeof e!=`object`)throw Error(`Invalid value! Only null, array and object is allowed.`)}var ct=class e extends Error{constructor(t,n,r=w.genericApplicationError){super(t),x(this,`data`),x(this,`code`),this.data=n,this.code=r,Object.setPrototypeOf(this,e.prototype)}},lt=class e{constructor(e,t,n,r,i=!1){x(this,`method`),x(this,`paramsSerializer`),x(this,`resultSerializer`),x(this,`errorSerializer`),x(this,`isOptional`),x(this,`kind`,`request`),this.method=e,this.paramsSerializer=t,this.resultSerializer=n,this.errorSerializer=r,this.isOptional=i}withMethod(t){return new e(t,this.paramsSerializer,this.resultSerializer,this.errorSerializer)}optional(){return new e(this.method,this.paramsSerializer,this.resultSerializer,this.errorSerializer,!0)}},ut=class e{constructor(e,t){x(this,`method`),x(this,`paramsSerializer`),x(this,`kind`,`notification`),this.method=e,this.paramsSerializer=t}withMethod(t){return new e(t,this.paramsSerializer)}};function E(e){return new lt((e||{}).method,T.sAny(),T.sAny(),T.sAny())}function D(e){return new ut((e||{}).method,T.sAny())}var dt=(Ue=Symbol(),S=class{constructor(e){x(this,`error`),x(this,Ue),this.error=e}},x(S,`factory`,e=>new S(e)),S);function ft(e){let t=pt(e.server),n=pt(e.client);return new mt(e.tags||[],t,n)}function pt(e){let t={};for(let[n,r]of Object.entries(e)){let e=r.method?r.method:n;t[n]=r.withMethod(e)}return t}var mt=class e{constructor(e=[],t,n){x(this,`tags`),x(this,`server`),x(this,`client`),this.tags=e,this.server=t,this.client=n}_onlyDesignTime(){return Error(`This property is not meant to be accessed at runtime`)}get TContractObject(){throw this._onlyDesignTime()}get TClientInterface(){throw this._onlyDesignTime()}get TServerInterface(){throw this._onlyDesignTime()}get TClientHandler(){throw this._onlyDesignTime()}get TServerHandler(){throw this._onlyDesignTime()}get TTags(){throw this._onlyDesignTime()}getInterface(e,t,n,r){let i=this.buildCounterpart(e,n),a=this.registerHandlers(e,t,r,i);return{counterpart:i,dispose:()=>a.dispose()}}buildCounterpart(e,t){let n={};for(let[r,i]of Object.entries(t)){let t;t=i.kind===`request`?i.isOptional?async(t,n)=>{t===void 0&&(t={});try{return await e.request(i,t,n)}catch(e){if(e&&e.code===w.methodNotFound)return rt;throw e}}:(t,n)=>(t===void 0&&(t={}),e.request(i,t,n)):(t,n)=>(t===void 0&&(t={}),e.notify(i,t,n)),n[r]=t}return n}registerHandlers(e,t,n,r){let i=[];for(let[a,o]of Object.entries(t))if(o.kind===`request`){let t=n[a];if(!t)continue;let s=this.createRequestHandler(r,t);i.push(e.registerRequestHandler(o,s))}else{let t=n[a];t&&i.push(e.registerNotificationHandler(o,(e,n)=>{t(e,{context:n,counterpart:r})}))}return{dispose:()=>i.forEach(e=>e.dispose())}}createRequestHandler(e,t){return async(n,r,i)=>{let a=await t(n,{context:i,counterpart:e,newErr:dt.factory,requestId:r});return a instanceof dt?a.error:{ok:a}}}static getServerFromStream(e,t,n,r){let i=ot.fromTransport(t,n),{server:a}=e.getServer(i,r);return i.startListen(),{channel:i,server:a}}static registerServerToStream(e,t,n,r){let i=ot.fromTransport(t,n),{client:a}=e.registerServer(i,r);return i.startListen(),{channel:i,client:a}}getServer(e,t){let{counterpart:n,dispose:r}=this.getInterface(e,this.client,this.server,t);return{server:n,dispose:r}}registerServer(e,t){let{counterpart:n,dispose:r}=this.getInterface(e,this.server,this.client,t);return{client:n,dispose:r}}withContext(){return new e(this.tags,this.server,this.client)}},ht=(function(e){return e.Comment=`comment`,e.Imports=`imports`,e.Region=`region`,e})({}),O=(function(e){return e[e.File=1]=`File`,e[e.Module=2]=`Module`,e[e.Namespace=3]=`Namespace`,e[e.Package=4]=`Package`,e[e.Class=5]=`Class`,e[e.Method=6]=`Method`,e[e.Property=7]=`Property`,e[e.Field=8]=`Field`,e[e.Constructor=9]=`Constructor`,e[e.Enum=10]=`Enum`,e[e.Interface=11]=`Interface`,e[e.Function=12]=`Function`,e[e.Variable=13]=`Variable`,e[e.Constant=14]=`Constant`,e[e.String=15]=`String`,e[e.Number=16]=`Number`,e[e.Boolean=17]=`Boolean`,e[e.Array=18]=`Array`,e[e.Object=19]=`Object`,e[e.Key=20]=`Key`,e[e.Null=21]=`Null`,e[e.EnumMember=22]=`EnumMember`,e[e.Struct=23]=`Struct`,e[e.Event=24]=`Event`,e[e.Operator=25]=`Operator`,e[e.TypeParameter=26]=`TypeParameter`,e})({}),gt=(function(e){return e[e.Deprecated=1]=`Deprecated`,e})({}),_t=(function(e){return e[e.Type=1]=`Type`,e[e.Parameter=2]=`Parameter`,e})({}),k=(function(e){return e[e.Text=1]=`Text`,e[e.Method=2]=`Method`,e[e.Function=3]=`Function`,e[e.Constructor=4]=`Constructor`,e[e.Field=5]=`Field`,e[e.Variable=6]=`Variable`,e[e.Class=7]=`Class`,e[e.Interface=8]=`Interface`,e[e.Module=9]=`Module`,e[e.Property=10]=`Property`,e[e.Unit=11]=`Unit`,e[e.Value=12]=`Value`,e[e.Enum=13]=`Enum`,e[e.Keyword=14]=`Keyword`,e[e.Snippet=15]=`Snippet`,e[e.Color=16]=`Color`,e[e.File=17]=`File`,e[e.Reference=18]=`Reference`,e[e.Folder=19]=`Folder`,e[e.EnumMember=20]=`EnumMember`,e[e.Constant=21]=`Constant`,e[e.Struct=22]=`Struct`,e[e.Event=23]=`Event`,e[e.Operator=24]=`Operator`,e[e.TypeParameter=25]=`TypeParameter`,e})({}),vt=(function(e){return e[e.Deprecated=1]=`Deprecated`,e})({}),yt=(function(e){return e[e.PlainText=1]=`PlainText`,e[e.Snippet=2]=`Snippet`,e})({}),bt=(function(e){return e[e.Text=1]=`Text`,e[e.Read=2]=`Read`,e[e.Write=3]=`Write`,e})({}),A=(function(e){return e.Empty=``,e.QuickFix=`quickfix`,e.Refactor=`refactor`,e.RefactorExtract=`refactor.extract`,e.RefactorInline=`refactor.inline`,e.RefactorRewrite=`refactor.rewrite`,e.Source=`source`,e.SourceOrganizeImports=`source.organizeImports`,e.SourceFixAll=`source.fixAll`,e})({}),j=(function(e){return e[e.Error=1]=`Error`,e[e.Warning=2]=`Warning`,e[e.Information=3]=`Information`,e[e.Hint=4]=`Hint`,e})({}),xt=(function(e){return e[e.Unnecessary=1]=`Unnecessary`,e[e.Deprecated=2]=`Deprecated`,e})({}),St=(function(e){return e[e.Invoked=1]=`Invoked`,e[e.TriggerCharacter=2]=`TriggerCharacter`,e[e.TriggerForIncompleteCompletions=3]=`TriggerForIncompleteCompletions`,e})({}),Ct=(function(e){return e[e.Invoked=1]=`Invoked`,e[e.TriggerCharacter=2]=`TriggerCharacter`,e[e.ContentChange=3]=`ContentChange`,e})({}),wt=(function(e){return e[e.Invoked=1]=`Invoked`,e[e.Automatic=2]=`Automatic`,e})({}),M=class{constructor(e){this.method=e}},Tt={textDocumentImplementation:new M(`textDocument/implementation`),textDocumentTypeDefinition:new M(`textDocument/typeDefinition`),textDocumentDocumentColor:new M(`textDocument/documentColor`),textDocumentColorPresentation:new M(`textDocument/colorPresentation`),textDocumentFoldingRange:new M(`textDocument/foldingRange`),textDocumentDeclaration:new M(`textDocument/declaration`),textDocumentSelectionRange:new M(`textDocument/selectionRange`),textDocumentPrepareCallHierarchy:new M(`textDocument/prepareCallHierarchy`),textDocumentSemanticTokensFull:new M(`textDocument/semanticTokens/full`),textDocumentSemanticTokensFullDelta:new M(`textDocument/semanticTokens/full/delta`),textDocumentLinkedEditingRange:new M(`textDocument/linkedEditingRange`),workspaceWillCreateFiles:new M(`workspace/willCreateFiles`),workspaceWillRenameFiles:new M(`workspace/willRenameFiles`),workspaceWillDeleteFiles:new M(`workspace/willDeleteFiles`),textDocumentMoniker:new M(`textDocument/moniker`),textDocumentPrepareTypeHierarchy:new M(`textDocument/prepareTypeHierarchy`),textDocumentInlineValue:new M(`textDocument/inlineValue`),textDocumentInlayHint:new M(`textDocument/inlayHint`),textDocumentDiagnostic:new M(`textDocument/diagnostic`),textDocumentInlineCompletion:new M(`textDocument/inlineCompletion`),textDocumentWillSaveWaitUntil:new M(`textDocument/willSaveWaitUntil`),textDocumentCompletion:new M(`textDocument/completion`),textDocumentHover:new M(`textDocument/hover`),textDocumentSignatureHelp:new M(`textDocument/signatureHelp`),textDocumentDefinition:new M(`textDocument/definition`),textDocumentReferences:new M(`textDocument/references`),textDocumentDocumentHighlight:new M(`textDocument/documentHighlight`),textDocumentDocumentSymbol:new M(`textDocument/documentSymbol`),textDocumentCodeAction:new M(`textDocument/codeAction`),workspaceSymbol:new M(`workspace/symbol`),textDocumentCodeLens:new M(`textDocument/codeLens`),textDocumentDocumentLink:new M(`textDocument/documentLink`),textDocumentFormatting:new M(`textDocument/formatting`),textDocumentRangeFormatting:new M(`textDocument/rangeFormatting`),textDocumentRangesFormatting:new M(`textDocument/rangesFormatting`),textDocumentOnTypeFormatting:new M(`textDocument/onTypeFormatting`),textDocumentRename:new M(`textDocument/rename`),workspaceExecuteCommand:new M(`workspace/executeCommand`),workspaceDidCreateFiles:new M(`workspace/didCreateFiles`),workspaceDidRenameFiles:new M(`workspace/didRenameFiles`),workspaceDidDeleteFiles:new M(`workspace/didDeleteFiles`),workspaceDidChangeConfiguration:new M(`workspace/didChangeConfiguration`),textDocumentDidOpen:new M(`textDocument/didOpen`),textDocumentDidChange:new M(`textDocument/didChange`),textDocumentDidClose:new M(`textDocument/didClose`),textDocumentDidSave:new M(`textDocument/didSave`),textDocumentWillSave:new M(`textDocument/willSave`),workspaceDidChangeWatchedFiles:new M(`workspace/didChangeWatchedFiles`)};ft({server:{textDocumentImplementation:E({method:`textDocument/implementation`}),textDocumentTypeDefinition:E({method:`textDocument/typeDefinition`}),textDocumentDocumentColor:E({method:`textDocument/documentColor`}),textDocumentColorPresentation:E({method:`textDocument/colorPresentation`}),textDocumentFoldingRange:E({method:`textDocument/foldingRange`}),textDocumentDeclaration:E({method:`textDocument/declaration`}),textDocumentSelectionRange:E({method:`textDocument/selectionRange`}),textDocumentPrepareCallHierarchy:E({method:`textDocument/prepareCallHierarchy`}),callHierarchyIncomingCalls:E({method:`callHierarchy/incomingCalls`}),callHierarchyOutgoingCalls:E({method:`callHierarchy/outgoingCalls`}),textDocumentSemanticTokensFull:E({method:`textDocument/semanticTokens/full`}),textDocumentSemanticTokensFullDelta:E({method:`textDocument/semanticTokens/full/delta`}),textDocumentSemanticTokensRange:E({method:`textDocument/semanticTokens/range`}),textDocumentLinkedEditingRange:E({method:`textDocument/linkedEditingRange`}),workspaceWillCreateFiles:E({method:`workspace/willCreateFiles`}),workspaceWillRenameFiles:E({method:`workspace/willRenameFiles`}),workspaceWillDeleteFiles:E({method:`workspace/willDeleteFiles`}),textDocumentMoniker:E({method:`textDocument/moniker`}),textDocumentPrepareTypeHierarchy:E({method:`textDocument/prepareTypeHierarchy`}),typeHierarchySupertypes:E({method:`typeHierarchy/supertypes`}),typeHierarchySubtypes:E({method:`typeHierarchy/subtypes`}),textDocumentInlineValue:E({method:`textDocument/inlineValue`}),textDocumentInlayHint:E({method:`textDocument/inlayHint`}),inlayHintResolve:E({method:`inlayHint/resolve`}),textDocumentDiagnostic:E({method:`textDocument/diagnostic`}),workspaceDiagnostic:E({method:`workspace/diagnostic`}),textDocumentInlineCompletion:E({method:`textDocument/inlineCompletion`}),initialize:E({method:`initialize`}),shutdown:E({method:`shutdown`}),textDocumentWillSaveWaitUntil:E({method:`textDocument/willSaveWaitUntil`}),textDocumentCompletion:E({method:`textDocument/completion`}),completionItemResolve:E({method:`completionItem/resolve`}),textDocumentHover:E({method:`textDocument/hover`}),textDocumentSignatureHelp:E({method:`textDocument/signatureHelp`}),textDocumentDefinition:E({method:`textDocument/definition`}),textDocumentReferences:E({method:`textDocument/references`}),textDocumentDocumentHighlight:E({method:`textDocument/documentHighlight`}),textDocumentDocumentSymbol:E({method:`textDocument/documentSymbol`}),textDocumentCodeAction:E({method:`textDocument/codeAction`}),codeActionResolve:E({method:`codeAction/resolve`}),workspaceSymbol:E({method:`workspace/symbol`}),workspaceSymbolResolve:E({method:`workspaceSymbol/resolve`}),textDocumentCodeLens:E({method:`textDocument/codeLens`}),codeLensResolve:E({method:`codeLens/resolve`}),textDocumentDocumentLink:E({method:`textDocument/documentLink`}),documentLinkResolve:E({method:`documentLink/resolve`}),textDocumentFormatting:E({method:`textDocument/formatting`}),textDocumentRangeFormatting:E({method:`textDocument/rangeFormatting`}),textDocumentRangesFormatting:E({method:`textDocument/rangesFormatting`}),textDocumentOnTypeFormatting:E({method:`textDocument/onTypeFormatting`}),textDocumentRename:E({method:`textDocument/rename`}),textDocumentPrepareRename:E({method:`textDocument/prepareRename`}),workspaceExecuteCommand:E({method:`workspace/executeCommand`}),workspaceDidChangeWorkspaceFolders:D({method:`workspace/didChangeWorkspaceFolders`}),windowWorkDoneProgressCancel:D({method:`window/workDoneProgress/cancel`}),workspaceDidCreateFiles:D({method:`workspace/didCreateFiles`}),workspaceDidRenameFiles:D({method:`workspace/didRenameFiles`}),workspaceDidDeleteFiles:D({method:`workspace/didDeleteFiles`}),notebookDocumentDidOpen:D({method:`notebookDocument/didOpen`}),notebookDocumentDidChange:D({method:`notebookDocument/didChange`}),notebookDocumentDidSave:D({method:`notebookDocument/didSave`}),notebookDocumentDidClose:D({method:`notebookDocument/didClose`}),initialized:D({method:`initialized`}),exit:D({method:`exit`}),workspaceDidChangeConfiguration:D({method:`workspace/didChangeConfiguration`}),textDocumentDidOpen:D({method:`textDocument/didOpen`}),textDocumentDidChange:D({method:`textDocument/didChange`}),textDocumentDidClose:D({method:`textDocument/didClose`}),textDocumentDidSave:D({method:`textDocument/didSave`}),textDocumentWillSave:D({method:`textDocument/willSave`}),workspaceDidChangeWatchedFiles:D({method:`workspace/didChangeWatchedFiles`}),setTrace:D({method:`$/setTrace`}),cancelRequest:D({method:`$/cancelRequest`}),progress:D({method:`$/progress`})},client:{workspaceWorkspaceFolders:E({method:`workspace/workspaceFolders`}).optional(),workspaceConfiguration:E({method:`workspace/configuration`}).optional(),workspaceFoldingRangeRefresh:E({method:`workspace/foldingRange/refresh`}).optional(),windowWorkDoneProgressCreate:E({method:`window/workDoneProgress/create`}).optional(),workspaceSemanticTokensRefresh:E({method:`workspace/semanticTokens/refresh`}).optional(),windowShowDocument:E({method:`window/showDocument`}).optional(),workspaceInlineValueRefresh:E({method:`workspace/inlineValue/refresh`}).optional(),workspaceInlayHintRefresh:E({method:`workspace/inlayHint/refresh`}).optional(),workspaceDiagnosticRefresh:E({method:`workspace/diagnostic/refresh`}).optional(),clientRegisterCapability:E({method:`client/registerCapability`}).optional(),clientUnregisterCapability:E({method:`client/unregisterCapability`}).optional(),windowShowMessageRequest:E({method:`window/showMessageRequest`}).optional(),workspaceCodeLensRefresh:E({method:`workspace/codeLens/refresh`}).optional(),workspaceApplyEdit:E({method:`workspace/applyEdit`}).optional(),windowShowMessage:D({method:`window/showMessage`}),windowLogMessage:D({method:`window/logMessage`}),telemetryEvent:D({method:`telemetry/event`}),textDocumentPublishDiagnostics:D({method:`textDocument/publishDiagnostics`}),logTrace:D({method:`$/logTrace`}),cancelRequest:D({method:`$/cancelRequest`}),progress:D({method:`$/progress`})}}),We=class{constructor(){x(this,`_store`,new Et)}dispose(){this._store.dispose()}_register(e){if(e===this)throw Error(`Cannot register a disposable on itself!`);return this._store.add(e)}},x(We,`None`,Object.freeze({dispose(){}}));var Et=(C=class{constructor(){x(this,`_toDispose`,new Set),x(this,`_isDisposed`,!1)}dispose(){this._isDisposed||(this._isDisposed=!0,this.clear())}clear(){if(this._toDispose.size!==0)try{for(let e of this._toDispose)e.dispose()}finally{this._toDispose.clear()}}add(e){if(!e)return e;if(e===this)throw Error(`Cannot register a disposable on itself!`);return this._isDisposed?C.DISABLE_DISPOSED_WARNING||console.warn(Error(`Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!`).stack):this._toDispose.add(e),e}},x(C,`DISABLE_DISPOSED_WARNING`,!1),C);A.Empty,A.QuickFix,A.Refactor,A.RefactorExtract,A.RefactorInline,A.RefactorRewrite,A.Source,A.SourceOrganizeImports,A.SourceFixAll,t.CodeActionTriggerType.Invoke,wt.Invoked,t.CodeActionTriggerType.Auto,wt.Automatic,k.Text,t.CompletionItemKind.Text,k.Method,t.CompletionItemKind.Method,k.Function,t.CompletionItemKind.Function,k.Constructor,t.CompletionItemKind.Constructor,k.Field,t.CompletionItemKind.Field,k.Variable,t.CompletionItemKind.Variable,k.Class,t.CompletionItemKind.Class,k.Interface,t.CompletionItemKind.Interface,k.Module,t.CompletionItemKind.Module,k.Property,t.CompletionItemKind.Property,k.Unit,t.CompletionItemKind.Unit,k.Value,t.CompletionItemKind.Value,k.Enum,t.CompletionItemKind.Enum,k.Keyword,t.CompletionItemKind.Keyword,k.Snippet,t.CompletionItemKind.Snippet,k.Color,t.CompletionItemKind.Color,k.File,t.CompletionItemKind.File,k.Reference,t.CompletionItemKind.Reference,k.Folder,t.CompletionItemKind.Folder,k.EnumMember,t.CompletionItemKind.EnumMember,k.Constant,t.CompletionItemKind.Constant,k.Struct,t.CompletionItemKind.Struct,k.Event,t.CompletionItemKind.Event,k.Operator,t.CompletionItemKind.Operator,k.TypeParameter,t.CompletionItemKind.TypeParameter,vt.Deprecated,t.CompletionItemTag.Deprecated,t.CompletionTriggerKind.Invoke,St.Invoked,t.CompletionTriggerKind.TriggerCharacter,St.TriggerCharacter,t.CompletionTriggerKind.TriggerForIncompleteCompletions,St.TriggerForIncompleteCompletions,yt.Snippet,t.CompletionItemInsertTextRule.InsertAsSnippet,O.File,t.SymbolKind.File,O.Module,t.SymbolKind.Module,O.Namespace,t.SymbolKind.Namespace,O.Package,t.SymbolKind.Package,O.Class,t.SymbolKind.Class,O.Method,t.SymbolKind.Method,O.Property,t.SymbolKind.Property,O.Field,t.SymbolKind.Field,O.Constructor,t.SymbolKind.Constructor,O.Enum,t.SymbolKind.Enum,O.Interface,t.SymbolKind.Interface,O.Function,t.SymbolKind.Function,O.Variable,t.SymbolKind.Variable,O.Constant,t.SymbolKind.Constant,O.String,t.SymbolKind.String,O.Number,t.SymbolKind.Number,O.Boolean,t.SymbolKind.Boolean,O.Array,t.SymbolKind.Array,O.Object,t.SymbolKind.Object,O.Key,t.SymbolKind.Key,O.Null,t.SymbolKind.Null,O.EnumMember,t.SymbolKind.EnumMember,O.Struct,t.SymbolKind.Struct,O.Event,t.SymbolKind.Event,O.Operator,t.SymbolKind.Operator,O.TypeParameter,t.SymbolKind.TypeParameter,gt.Deprecated,t.SymbolTag.Deprecated,bt.Text,t.DocumentHighlightKind.Text,bt.Read,t.DocumentHighlightKind.Read,bt.Write,t.DocumentHighlightKind.Write,ht.Comment,t.FoldingRangeKind.Comment,ht.Imports,t.FoldingRangeKind.Imports,ht.Region,t.FoldingRangeKind.Region,i.Error,j.Error,i.Warning,j.Warning,i.Info,j.Information,i.Hint,j.Hint,j.Error,i.Error,j.Warning,i.Warning,j.Information,i.Info,j.Hint,i.Hint,xt.Unnecessary,o.Unnecessary,xt.Deprecated,o.Deprecated,t.SignatureHelpTriggerKind.Invoke,Ct.Invoked,t.SignatureHelpTriggerKind.TriggerCharacter,Ct.TriggerCharacter,t.SignatureHelpTriggerKind.ContentChange,Ct.ContentChange,_t.Type,t.InlayHintKind.Type,_t.Parameter,t.InlayHintKind.Parameter,new Map([...Object.values(Tt)].map(e=>[e.method,e])),typeof WebSocket<`u`||(typeof MozWebSocket<`u`?MozWebSocket:typeof global<`u`?global.WebSocket||global.MozWebSocket:typeof window<`u`?window.WebSocket||window.MozWebSocket:typeof self<`u`&&(self.WebSocket||self.MozWebSocket));function Dt(){return s}globalThis.MonacoEnvironment?.globalAPI&&(globalThis.monaco=Dt());var N=Dt();N.languages.css=ne,N.languages.html=le,N.languages.typescript=Te,N.languages.json=be;var P=class{constructor(e,t){this._modeId=e,this._defaults=t,this._worker=null,this._client=null,this._configChangeListener=this._defaults.onDidChange(()=>this._stopWorker()),this._updateExtraLibsToken=0,this._extraLibsChangeListener=this._defaults.onDidExtraLibsChange(()=>this._updateExtraLibs())}dispose(){this._configChangeListener.dispose(),this._extraLibsChangeListener.dispose(),this._stopWorker()}_stopWorker(){this._worker&&=(this._worker.dispose(),null),this._client=null}async _updateExtraLibs(){if(!this._worker)return;let e=++this._updateExtraLibsToken,t=await this._worker.getProxy();this._updateExtraLibsToken===e&&t.updateExtraLibs(this._defaults.getExtraLibs())}_getClient(){return this._client||=(async()=>(this._worker=u({moduleId:`vs/language/typescript/tsWorker`,createWorker:()=>new Worker(new URL(``+new URL(`ts.worker-DI5g4t5j.js`,import.meta.url).href,``+import.meta.url),{type:`module`}),label:this._modeId,keepIdleModels:!0,createData:{compilerOptions:this._defaults.getCompilerOptions(),extraLibs:this._defaults.getExtraLibs(),customWorkerPath:this._defaults.workerOptions.customWorkerPath,inlayHintsOptions:this._defaults.inlayHintsOptions}}),this._defaults.getEagerModelSync()?await this._worker.withSyncedResources(a.getModels().filter(e=>e.getLanguageId()===this._modeId).map(e=>e.uri)):await this._worker.getProxy()))(),this._client}async getLanguageServiceWorker(...e){let t=await this._getClient();return this._worker&&await this._worker.withSyncedResources(e),t}},Ot=120*1e3,F=class{constructor(e){this._defaults=e,this._worker=null,this._client=null,this._idleCheckInterval=window.setInterval(()=>this._checkIfIdle(),30*1e3),this._lastUsedTime=0,this._configChangeListener=this._defaults.onDidChange(()=>this._stopWorker())}_stopWorker(){this._worker&&=(this._worker.dispose(),null),this._client=null}dispose(){clearInterval(this._idleCheckInterval),this._configChangeListener.dispose(),this._stopWorker()}_checkIfIdle(){this._worker&&Date.now()-this._lastUsedTime>Ot&&this._stopWorker()}_getClient(){return this._lastUsedTime=Date.now(),this._client||=(this._worker=u({moduleId:`vs/language/html/htmlWorker`,createWorker:()=>new Worker(new URL(``+new URL(`html.worker-Dg1SpGQ4.js`,import.meta.url).href,``+import.meta.url),{type:`module`}),createData:{languageSettings:this._defaults.options,languageId:this._defaults.languageId},label:this._defaults.languageId}),this._worker.getProxy()),this._client}getLanguageServiceWorker(...e){let t;return this._getClient().then(e=>{t=e}).then(t=>{if(this._worker)return this._worker.withSyncedResources(e)}).then(e=>t)}},kt;(function(e){function t(e){return typeof e==`string`}e.is=t})(kt||={});var At;(function(e){function t(e){return typeof e==`string`}e.is=t})(At||={});var jt;(function(e){e.MIN_VALUE=-2147483648,e.MAX_VALUE=2147483647;function t(t){return typeof t==`number`&&e.MIN_VALUE<=t&&t<=e.MAX_VALUE}e.is=t})(jt||={});var Mt;(function(e){e.MIN_VALUE=0,e.MAX_VALUE=2147483647;function t(t){return typeof t==`number`&&e.MIN_VALUE<=t&&t<=e.MAX_VALUE}e.is=t})(Mt||={});var I;(function(e){function t(e,t){return e===Number.MAX_VALUE&&(e=Mt.MAX_VALUE),t===Number.MAX_VALUE&&(t=Mt.MAX_VALUE),{line:e,character:t}}e.create=t;function n(e){let t=e;return q.objectLiteral(t)&&q.uinteger(t.line)&&q.uinteger(t.character)}e.is=n})(I||={});var L;(function(e){function t(e,t,n,r){if(q.uinteger(e)&&q.uinteger(t)&&q.uinteger(n)&&q.uinteger(r))return{start:I.create(e,t),end:I.create(n,r)};if(I.is(e)&&I.is(t))return{start:e,end:t};throw Error(`Range#create called with invalid arguments[${e}, ${t}, ${n}, ${r}]`)}e.create=t;function n(e){let t=e;return q.objectLiteral(t)&&I.is(t.start)&&I.is(t.end)}e.is=n})(L||={});var Nt;(function(e){function t(e,t){return{uri:e,range:t}}e.create=t;function n(e){let t=e;return q.objectLiteral(t)&&L.is(t.range)&&(q.string(t.uri)||q.undefined(t.uri))}e.is=n})(Nt||={});var Pt;(function(e){function t(e,t,n,r){return{targetUri:e,targetRange:t,targetSelectionRange:n,originSelectionRange:r}}e.create=t;function n(e){let t=e;return q.objectLiteral(t)&&L.is(t.targetRange)&&q.string(t.targetUri)&&L.is(t.targetSelectionRange)&&(L.is(t.originSelectionRange)||q.undefined(t.originSelectionRange))}e.is=n})(Pt||={});var Ft;(function(e){function t(e,t,n,r){return{red:e,green:t,blue:n,alpha:r}}e.create=t;function n(e){let t=e;return q.objectLiteral(t)&&q.numberRange(t.red,0,1)&&q.numberRange(t.green,0,1)&&q.numberRange(t.blue,0,1)&&q.numberRange(t.alpha,0,1)}e.is=n})(Ft||={});var It;(function(e){function t(e,t){return{range:e,color:t}}e.create=t;function n(e){let t=e;return q.objectLiteral(t)&&L.is(t.range)&&Ft.is(t.color)}e.is=n})(It||={});var Lt;(function(e){function t(e,t,n){return{label:e,textEdit:t,additionalTextEdits:n}}e.create=t;function n(e){let t=e;return q.objectLiteral(t)&&q.string(t.label)&&(q.undefined(t.textEdit)||V.is(t))&&(q.undefined(t.additionalTextEdits)||q.typedArray(t.additionalTextEdits,V.is))}e.is=n})(Lt||={});var R;(function(e){e.Comment=`comment`,e.Imports=`imports`,e.Region=`region`})(R||={});var Rt;(function(e){function t(e,t,n,r,i,a){let o={startLine:e,endLine:t};return q.defined(n)&&(o.startCharacter=n),q.defined(r)&&(o.endCharacter=r),q.defined(i)&&(o.kind=i),q.defined(a)&&(o.collapsedText=a),o}e.create=t;function n(e){let t=e;return q.objectLiteral(t)&&q.uinteger(t.startLine)&&q.uinteger(t.startLine)&&(q.undefined(t.startCharacter)||q.uinteger(t.startCharacter))&&(q.undefined(t.endCharacter)||q.uinteger(t.endCharacter))&&(q.undefined(t.kind)||q.string(t.kind))}e.is=n})(Rt||={});var zt;(function(e){function t(e,t){return{location:e,message:t}}e.create=t;function n(e){let t=e;return q.defined(t)&&Nt.is(t.location)&&q.string(t.message)}e.is=n})(zt||={});var z;(function(e){e.Error=1,e.Warning=2,e.Information=3,e.Hint=4})(z||={});var Bt;(function(e){e.Unnecessary=1,e.Deprecated=2})(Bt||={});var Vt;(function(e){function t(e){let t=e;return q.objectLiteral(t)&&q.string(t.href)}e.is=t})(Vt||={});var Ht;(function(e){function t(e,t,n,r,i,a){let o={range:e,message:t};return q.defined(n)&&(o.severity=n),q.defined(r)&&(o.code=r),q.defined(i)&&(o.source=i),q.defined(a)&&(o.relatedInformation=a),o}e.create=t;function n(e){let t=e;return q.defined(t)&&L.is(t.range)&&q.string(t.message)&&(q.number(t.severity)||q.undefined(t.severity))&&(q.integer(t.code)||q.string(t.code)||q.undefined(t.code))&&(q.undefined(t.codeDescription)||q.string(t.codeDescription?.href))&&(q.string(t.source)||q.undefined(t.source))&&(q.undefined(t.relatedInformation)||q.typedArray(t.relatedInformation,zt.is))}e.is=n})(Ht||={});var B;(function(e){function t(e,t,...n){let r={title:e,command:t};return q.defined(n)&&n.length>0&&(r.arguments=n),r}e.create=t;function n(e){let t=e;return q.defined(t)&&q.string(t.title)&&q.string(t.command)}e.is=n})(B||={});var V;(function(e){function t(e,t){return{range:e,newText:t}}e.replace=t;function n(e,t){return{range:{start:e,end:e},newText:t}}e.insert=n;function r(e){return{range:e,newText:``}}e.del=r;function i(e){let t=e;return q.objectLiteral(t)&&q.string(t.newText)&&L.is(t.range)}e.is=i})(V||={});var Ut;(function(e){function t(e,t,n){let r={label:e};return t!==void 0&&(r.needsConfirmation=t),n!==void 0&&(r.description=n),r}e.create=t;function n(e){let t=e;return q.objectLiteral(t)&&q.string(t.label)&&(q.boolean(t.needsConfirmation)||t.needsConfirmation===void 0)&&(q.string(t.description)||t.description===void 0)}e.is=n})(Ut||={});var H;(function(e){function t(e){let t=e;return q.string(t)}e.is=t})(H||={});var Wt;(function(e){function t(e,t,n){return{range:e,newText:t,annotationId:n}}e.replace=t;function n(e,t,n){return{range:{start:e,end:e},newText:t,annotationId:n}}e.insert=n;function r(e,t){return{range:e,newText:``,annotationId:t}}e.del=r;function i(e){let t=e;return V.is(t)&&(Ut.is(t.annotationId)||H.is(t.annotationId))}e.is=i})(Wt||={});var Gt;(function(e){function t(e,t){return{textDocument:e,edits:t}}e.create=t;function n(e){let t=e;return q.defined(t)&&Qt.is(t.textDocument)&&Array.isArray(t.edits)}e.is=n})(Gt||={});var Kt;(function(e){function t(e,t,n){let r={kind:`create`,uri:e};return t!==void 0&&(t.overwrite!==void 0||t.ignoreIfExists!==void 0)&&(r.options=t),n!==void 0&&(r.annotationId=n),r}e.create=t;function n(e){let t=e;return t&&t.kind===`create`&&q.string(t.uri)&&(t.options===void 0||(t.options.overwrite===void 0||q.boolean(t.options.overwrite))&&(t.options.ignoreIfExists===void 0||q.boolean(t.options.ignoreIfExists)))&&(t.annotationId===void 0||H.is(t.annotationId))}e.is=n})(Kt||={});var qt;(function(e){function t(e,t,n,r){let i={kind:`rename`,oldUri:e,newUri:t};return n!==void 0&&(n.overwrite!==void 0||n.ignoreIfExists!==void 0)&&(i.options=n),r!==void 0&&(i.annotationId=r),i}e.create=t;function n(e){let t=e;return t&&t.kind===`rename`&&q.string(t.oldUri)&&q.string(t.newUri)&&(t.options===void 0||(t.options.overwrite===void 0||q.boolean(t.options.overwrite))&&(t.options.ignoreIfExists===void 0||q.boolean(t.options.ignoreIfExists)))&&(t.annotationId===void 0||H.is(t.annotationId))}e.is=n})(qt||={});var Jt;(function(e){function t(e,t,n){let r={kind:`delete`,uri:e};return t!==void 0&&(t.recursive!==void 0||t.ignoreIfNotExists!==void 0)&&(r.options=t),n!==void 0&&(r.annotationId=n),r}e.create=t;function n(e){let t=e;return t&&t.kind===`delete`&&q.string(t.uri)&&(t.options===void 0||(t.options.recursive===void 0||q.boolean(t.options.recursive))&&(t.options.ignoreIfNotExists===void 0||q.boolean(t.options.ignoreIfNotExists)))&&(t.annotationId===void 0||H.is(t.annotationId))}e.is=n})(Jt||={});var Yt;(function(e){function t(e){let t=e;return t&&(t.changes!==void 0||t.documentChanges!==void 0)&&(t.documentChanges===void 0||t.documentChanges.every(e=>q.string(e.kind)?Kt.is(e)||qt.is(e)||Jt.is(e):Gt.is(e)))}e.is=t})(Yt||={});var Xt;(function(e){function t(e){return{uri:e}}e.create=t;function n(e){let t=e;return q.defined(t)&&q.string(t.uri)}e.is=n})(Xt||={});var Zt;(function(e){function t(e,t){return{uri:e,version:t}}e.create=t;function n(e){let t=e;return q.defined(t)&&q.string(t.uri)&&q.integer(t.version)}e.is=n})(Zt||={});var Qt;(function(e){function t(e,t){return{uri:e,version:t}}e.create=t;function n(e){let t=e;return q.defined(t)&&q.string(t.uri)&&(t.version===null||q.integer(t.version))}e.is=n})(Qt||={});var $t;(function(e){function t(e,t,n,r){return{uri:e,languageId:t,version:n,text:r}}e.create=t;function n(e){let t=e;return q.defined(t)&&q.string(t.uri)&&q.string(t.languageId)&&q.integer(t.version)&&q.string(t.text)}e.is=n})($t||={});var en;(function(e){e.PlainText=`plaintext`,e.Markdown=`markdown`;function t(t){let n=t;return n===e.PlainText||n===e.Markdown}e.is=t})(en||={});var U;(function(e){function t(e){let t=e;return q.objectLiteral(e)&&en.is(t.kind)&&q.string(t.value)}e.is=t})(U||={});var W;(function(e){e.Text=1,e.Method=2,e.Function=3,e.Constructor=4,e.Field=5,e.Variable=6,e.Class=7,e.Interface=8,e.Module=9,e.Property=10,e.Unit=11,e.Value=12,e.Enum=13,e.Keyword=14,e.Snippet=15,e.Color=16,e.File=17,e.Reference=18,e.Folder=19,e.EnumMember=20,e.Constant=21,e.Struct=22,e.Event=23,e.Operator=24,e.TypeParameter=25})(W||={});var tn;(function(e){e.PlainText=1,e.Snippet=2})(tn||={});var nn;(function(e){e.Deprecated=1})(nn||={});var rn;(function(e){function t(e,t,n){return{newText:e,insert:t,replace:n}}e.create=t;function n(e){let t=e;return t&&q.string(t.newText)&&L.is(t.insert)&&L.is(t.replace)}e.is=n})(rn||={});var an;(function(e){e.asIs=1,e.adjustIndentation=2})(an||={});var on;(function(e){function t(e){let t=e;return t&&(q.string(t.detail)||t.detail===void 0)&&(q.string(t.description)||t.description===void 0)}e.is=t})(on||={});var sn;(function(e){function t(e){return{label:e}}e.create=t})(sn||={});var cn;(function(e){function t(e,t){return{items:e||[],isIncomplete:!!t}}e.create=t})(cn||={});var ln;(function(e){function t(e){return e.replace(/[\\`*_{}[\]()#+\-.!]/g,`\\$&`)}e.fromPlainText=t;function n(e){let t=e;return q.string(t)||q.objectLiteral(t)&&q.string(t.language)&&q.string(t.value)}e.is=n})(ln||={});var un;(function(e){function t(e){let t=e;return!!t&&q.objectLiteral(t)&&(U.is(t.contents)||ln.is(t.contents)||q.typedArray(t.contents,ln.is))&&(e.range===void 0||L.is(e.range))}e.is=t})(un||={});var dn;(function(e){function t(e,t){return t?{label:e,documentation:t}:{label:e}}e.create=t})(dn||={});var fn;(function(e){function t(e,t,...n){let r={label:e};return q.defined(t)&&(r.documentation=t),q.defined(n)?r.parameters=n:r.parameters=[],r}e.create=t})(fn||={});var G;(function(e){e.Text=1,e.Read=2,e.Write=3})(G||={});var pn;(function(e){function t(e,t){let n={range:e};return q.number(t)&&(n.kind=t),n}e.create=t})(pn||={});var K;(function(e){e.File=1,e.Module=2,e.Namespace=3,e.Package=4,e.Class=5,e.Method=6,e.Property=7,e.Field=8,e.Constructor=9,e.Enum=10,e.Interface=11,e.Function=12,e.Variable=13,e.Constant=14,e.String=15,e.Number=16,e.Boolean=17,e.Array=18,e.Object=19,e.Key=20,e.Null=21,e.EnumMember=22,e.Struct=23,e.Event=24,e.Operator=25,e.TypeParameter=26})(K||={});var mn;(function(e){e.Deprecated=1})(mn||={});var hn;(function(e){function t(e,t,n,r,i){let a={name:e,kind:t,location:{uri:r,range:n}};return i&&(a.containerName=i),a}e.create=t})(hn||={});var gn;(function(e){function t(e,t,n,r){return r===void 0?{name:e,kind:t,location:{uri:n}}:{name:e,kind:t,location:{uri:n,range:r}}}e.create=t})(gn||={});var _n;(function(e){function t(e,t,n,r,i,a){let o={name:e,detail:t,kind:n,range:r,selectionRange:i};return a!==void 0&&(o.children=a),o}e.create=t;function n(e){let t=e;return t&&q.string(t.name)&&q.number(t.kind)&&L.is(t.range)&&L.is(t.selectionRange)&&(t.detail===void 0||q.string(t.detail))&&(t.deprecated===void 0||q.boolean(t.deprecated))&&(t.children===void 0||Array.isArray(t.children))&&(t.tags===void 0||Array.isArray(t.tags))}e.is=n})(_n||={});var vn;(function(e){e.Empty=``,e.QuickFix=`quickfix`,e.Refactor=`refactor`,e.RefactorExtract=`refactor.extract`,e.RefactorInline=`refactor.inline`,e.RefactorRewrite=`refactor.rewrite`,e.Source=`source`,e.SourceOrganizeImports=`source.organizeImports`,e.SourceFixAll=`source.fixAll`})(vn||={});var yn;(function(e){e.Invoked=1,e.Automatic=2})(yn||={});var bn;(function(e){function t(e,t,n){let r={diagnostics:e};return t!=null&&(r.only=t),n!=null&&(r.triggerKind=n),r}e.create=t;function n(e){let t=e;return q.defined(t)&&q.typedArray(t.diagnostics,Ht.is)&&(t.only===void 0||q.typedArray(t.only,q.string))&&(t.triggerKind===void 0||t.triggerKind===yn.Invoked||t.triggerKind===yn.Automatic)}e.is=n})(bn||={});var xn;(function(e){function t(e,t,n){let r={title:e},i=!0;return typeof t==`string`?(i=!1,r.kind=t):B.is(t)?r.command=t:r.edit=t,i&&n!==void 0&&(r.kind=n),r}e.create=t;function n(e){let t=e;return t&&q.string(t.title)&&(t.diagnostics===void 0||q.typedArray(t.diagnostics,Ht.is))&&(t.kind===void 0||q.string(t.kind))&&(t.edit!==void 0||t.command!==void 0)&&(t.command===void 0||B.is(t.command))&&(t.isPreferred===void 0||q.boolean(t.isPreferred))&&(t.edit===void 0||Yt.is(t.edit))}e.is=n})(xn||={});var Sn;(function(e){function t(e,t){let n={range:e};return q.defined(t)&&(n.data=t),n}e.create=t;function n(e){let t=e;return q.defined(t)&&L.is(t.range)&&(q.undefined(t.command)||B.is(t.command))}e.is=n})(Sn||={});var Cn;(function(e){function t(e,t){return{tabSize:e,insertSpaces:t}}e.create=t;function n(e){let t=e;return q.defined(t)&&q.uinteger(t.tabSize)&&q.boolean(t.insertSpaces)}e.is=n})(Cn||={});var wn;(function(e){function t(e,t,n){return{range:e,target:t,data:n}}e.create=t;function n(e){let t=e;return q.defined(t)&&L.is(t.range)&&(q.undefined(t.target)||q.string(t.target))}e.is=n})(wn||={});var Tn;(function(e){function t(e,t){return{range:e,parent:t}}e.create=t;function n(t){let n=t;return q.objectLiteral(n)&&L.is(n.range)&&(n.parent===void 0||e.is(n.parent))}e.is=n})(Tn||={});var En;(function(e){e.namespace=`namespace`,e.type=`type`,e.class=`class`,e.enum=`enum`,e.interface=`interface`,e.struct=`struct`,e.typeParameter=`typeParameter`,e.parameter=`parameter`,e.variable=`variable`,e.property=`property`,e.enumMember=`enumMember`,e.event=`event`,e.function=`function`,e.method=`method`,e.macro=`macro`,e.keyword=`keyword`,e.modifier=`modifier`,e.comment=`comment`,e.string=`string`,e.number=`number`,e.regexp=`regexp`,e.operator=`operator`,e.decorator=`decorator`})(En||={});var Dn;(function(e){e.declaration=`declaration`,e.definition=`definition`,e.readonly=`readonly`,e.static=`static`,e.deprecated=`deprecated`,e.abstract=`abstract`,e.async=`async`,e.modification=`modification`,e.documentation=`documentation`,e.defaultLibrary=`defaultLibrary`})(Dn||={});var On;(function(e){function t(e){let t=e;return q.objectLiteral(t)&&(t.resultId===void 0||typeof t.resultId==`string`)&&Array.isArray(t.data)&&(t.data.length===0||typeof t.data[0]==`number`)}e.is=t})(On||={});var kn;(function(e){function t(e,t){return{range:e,text:t}}e.create=t;function n(e){let t=e;return t!=null&&L.is(t.range)&&q.string(t.text)}e.is=n})(kn||={});var An;(function(e){function t(e,t,n){return{range:e,variableName:t,caseSensitiveLookup:n}}e.create=t;function n(e){let t=e;return t!=null&&L.is(t.range)&&q.boolean(t.caseSensitiveLookup)&&(q.string(t.variableName)||t.variableName===void 0)}e.is=n})(An||={});var jn;(function(e){function t(e,t){return{range:e,expression:t}}e.create=t;function n(e){let t=e;return t!=null&&L.is(t.range)&&(q.string(t.expression)||t.expression===void 0)}e.is=n})(jn||={});var Mn;(function(e){function t(e,t){return{frameId:e,stoppedLocation:t}}e.create=t;function n(e){let t=e;return q.defined(t)&&L.is(e.stoppedLocation)}e.is=n})(Mn||={});var Nn;(function(e){e.Type=1,e.Parameter=2;function t(e){return e===1||e===2}e.is=t})(Nn||={});var Pn;(function(e){function t(e){return{value:e}}e.create=t;function n(e){let t=e;return q.objectLiteral(t)&&(t.tooltip===void 0||q.string(t.tooltip)||U.is(t.tooltip))&&(t.location===void 0||Nt.is(t.location))&&(t.command===void 0||B.is(t.command))}e.is=n})(Pn||={});var Fn;(function(e){function t(e,t,n){let r={position:e,label:t};return n!==void 0&&(r.kind=n),r}e.create=t;function n(e){let t=e;return q.objectLiteral(t)&&I.is(t.position)&&(q.string(t.label)||q.typedArray(t.label,Pn.is))&&(t.kind===void 0||Nn.is(t.kind))&&t.textEdits===void 0||q.typedArray(t.textEdits,V.is)&&(t.tooltip===void 0||q.string(t.tooltip)||U.is(t.tooltip))&&(t.paddingLeft===void 0||q.boolean(t.paddingLeft))&&(t.paddingRight===void 0||q.boolean(t.paddingRight))}e.is=n})(Fn||={});var In;(function(e){function t(e){return{kind:`snippet`,value:e}}e.createSnippet=t})(In||={});var Ln;(function(e){function t(e,t,n,r){return{insertText:e,filterText:t,range:n,command:r}}e.create=t})(Ln||={});var Rn;(function(e){function t(e){return{items:e}}e.create=t})(Rn||={});var zn;(function(e){e.Invoked=0,e.Automatic=1})(zn||={});var Bn;(function(e){function t(e,t){return{range:e,text:t}}e.create=t})(Bn||={});var Vn;(function(e){function t(e,t){return{triggerKind:e,selectedCompletionInfo:t}}e.create=t})(Vn||={});var Hn;(function(e){function t(e){let t=e;return q.objectLiteral(t)&&At.is(t.uri)&&q.string(t.name)}e.is=t})(Hn||={});var Un;(function(e){function t(e,t,n,r){return new Wn(e,t,n,r)}e.create=t;function n(e){let t=e;return!!(q.defined(t)&&q.string(t.uri)&&(q.undefined(t.languageId)||q.string(t.languageId))&&q.uinteger(t.lineCount)&&q.func(t.getText)&&q.func(t.positionAt)&&q.func(t.offsetAt))}e.is=n;function r(e,t){let n=e.getText(),r=i(t,(e,t)=>{let n=e.range.start.line-t.range.start.line;return n===0?e.range.start.character-t.range.start.character:n}),a=n.length;for(let t=r.length-1;t>=0;t--){let i=r[t],o=e.offsetAt(i.range.start),s=e.offsetAt(i.range.end);if(s<=a)n=n.substring(0,o)+i.newText+n.substring(s,n.length);else throw Error(`Overlapping edit`);a=o}return n}e.applyEdits=r;function i(e,t){if(e.length<=1)return e;let n=e.length/2|0,r=e.slice(0,n),a=e.slice(n);i(r,t),i(a,t);let o=0,s=0,c=0;for(;o<r.length&&s<a.length;)t(r[o],a[s])<=0?e[c++]=r[o++]:e[c++]=a[s++];for(;o<r.length;)e[c++]=r[o++];for(;s<a.length;)e[c++]=a[s++];return e}})(Un||={});var Wn=class{constructor(e,t,n,r){this._uri=e,this._languageId=t,this._version=n,this._content=r,this._lineOffsets=void 0}get uri(){return this._uri}get languageId(){return this._languageId}get version(){return this._version}getText(e){if(e){let t=this.offsetAt(e.start),n=this.offsetAt(e.end);return this._content.substring(t,n)}return this._content}update(e,t){this._content=e.text,this._version=t,this._lineOffsets=void 0}getLineOffsets(){if(this._lineOffsets===void 0){let e=[],t=this._content,n=!0;for(let r=0;r<t.length;r++){n&&=(e.push(r),!1);let i=t.charAt(r);n=i===`\r`||i===`
`,i===`\r`&&r+1<t.length&&t.charAt(r+1)===`
`&&r++}n&&t.length>0&&e.push(t.length),this._lineOffsets=e}return this._lineOffsets}positionAt(e){e=Math.max(Math.min(e,this._content.length),0);let t=this.getLineOffsets(),n=0,r=t.length;if(r===0)return I.create(0,e);for(;n<r;){let i=Math.floor((n+r)/2);t[i]>e?r=i:n=i+1}let i=n-1;return I.create(i,e-t[i])}offsetAt(e){let t=this.getLineOffsets();if(e.line>=t.length)return this._content.length;if(e.line<0)return 0;let n=t[e.line],r=e.line+1<t.length?t[e.line+1]:this._content.length;return Math.max(Math.min(n+e.character,r),n)}get lineCount(){return this.getLineOffsets().length}},q;(function(e){let t=Object.prototype.toString;function n(e){return e!==void 0}e.defined=n;function r(e){return e===void 0}e.undefined=r;function i(e){return e===!0||e===!1}e.boolean=i;function a(e){return t.call(e)===`[object String]`}e.string=a;function o(e){return t.call(e)===`[object Number]`}e.number=o;function s(e,n,r){return t.call(e)===`[object Number]`&&n<=e&&e<=r}e.numberRange=s;function c(e){return t.call(e)===`[object Number]`&&-2147483648<=e&&e<=2147483647}e.integer=c;function l(e){return t.call(e)===`[object Number]`&&0<=e&&e<=2147483647}e.uinteger=l;function u(e){return t.call(e)===`[object Function]`}e.func=u;function d(e){return typeof e==`object`&&!!e}e.objectLiteral=d;function ee(e,t){return Array.isArray(e)&&e.every(t)}e.typedArray=ee})(q||={});var Gn=class{constructor(e,t,n){this._languageId=e,this._worker=t,this._disposables=[],this._listener=Object.create(null);let r=e=>{let t=e.getLanguageId();if(t!==this._languageId)return;let n;this._listener[e.uri.toString()]=e.onDidChangeContent(()=>{window.clearTimeout(n),n=window.setTimeout(()=>this._doValidate(e.uri,t),500)}),this._doValidate(e.uri,t)},i=e=>{a.setModelMarkers(e,this._languageId,[]);let t=e.uri.toString(),n=this._listener[t];n&&(n.dispose(),delete this._listener[t])};this._disposables.push(a.onDidCreateModel(r)),this._disposables.push(a.onWillDisposeModel(i)),this._disposables.push(a.onDidChangeModelLanguage(e=>{i(e.model),r(e.model)})),this._disposables.push(n(e=>{a.getModels().forEach(e=>{e.getLanguageId()===this._languageId&&(i(e),r(e))})})),this._disposables.push({dispose:()=>{a.getModels().forEach(i);for(let e in this._listener)this._listener[e].dispose()}}),a.getModels().forEach(r)}dispose(){this._disposables.forEach(e=>e&&e.dispose()),this._disposables.length=0}_doValidate(e,t){this._worker(e).then(t=>t.doValidation(e.toString())).then(n=>{let r=n.map(t=>qn(e,t)),i=a.getModel(e);i&&i.getLanguageId()===t&&a.setModelMarkers(i,t,r)}).then(void 0,e=>{console.error(e)})}};function Kn(e){switch(e){case z.Error:return i.Error;case z.Warning:return i.Warning;case z.Information:return i.Info;case z.Hint:return i.Hint;default:return i.Info}}function qn(e,t){let n=typeof t.code==`number`?String(t.code):t.code;return{severity:Kn(t.severity),startLineNumber:t.range.start.line+1,startColumn:t.range.start.character+1,endLineNumber:t.range.end.line+1,endColumn:t.range.end.character+1,message:t.message,code:n,source:t.source}}var Jn=class{constructor(e,t){this._worker=e,this._triggerCharacters=t}get triggerCharacters(){return this._triggerCharacters}provideCompletionItems(e,r,i,a){let o=e.uri;return this._worker(o).then(e=>e.doComplete(o.toString(),J(r))).then(i=>{if(!i)return;let a=e.getWordUntilPosition(r),o=new n(r.lineNumber,a.startColumn,r.lineNumber,a.endColumn),s=i.items.map(e=>{let n={label:e.label,insertText:e.insertText||e.label,sortText:e.sortText,filterText:e.filterText,documentation:e.documentation,detail:e.detail,command:Qn(e.command),range:o,kind:Zn(e.kind)};return e.textEdit&&(Xn(e.textEdit)?n.range={insert:Y(e.textEdit.insert),replace:Y(e.textEdit.replace)}:n.range=Y(e.textEdit.range),n.insertText=e.textEdit.newText),e.additionalTextEdits&&(n.additionalTextEdits=e.additionalTextEdits.map(X)),e.insertTextFormat===tn.Snippet&&(n.insertTextRules=t.CompletionItemInsertTextRule.InsertAsSnippet),n});return{isIncomplete:i.isIncomplete,suggestions:s}})}};function J(e){if(e)return{character:e.column-1,line:e.lineNumber-1}}function Yn(e){if(e)return{start:{line:e.startLineNumber-1,character:e.startColumn-1},end:{line:e.endLineNumber-1,character:e.endColumn-1}}}function Y(e){if(e)return new n(e.start.line+1,e.start.character+1,e.end.line+1,e.end.character+1)}function Xn(e){return e.insert!==void 0&&e.replace!==void 0}function Zn(e){let n=t.CompletionItemKind;switch(e){case W.Text:return n.Text;case W.Method:return n.Method;case W.Function:return n.Function;case W.Constructor:return n.Constructor;case W.Field:return n.Field;case W.Variable:return n.Variable;case W.Class:return n.Class;case W.Interface:return n.Interface;case W.Module:return n.Module;case W.Property:return n.Property;case W.Unit:return n.Unit;case W.Value:return n.Value;case W.Enum:return n.Enum;case W.Keyword:return n.Keyword;case W.Snippet:return n.Snippet;case W.Color:return n.Color;case W.File:return n.File;case W.Reference:return n.Reference}return n.Property}function X(e){if(e)return{range:Y(e.range),text:e.newText}}function Qn(e){return e&&e.command===`editor.action.triggerSuggest`?{id:e.command,title:e.title,arguments:e.arguments}:void 0}var $n=class{constructor(e){this._worker=e}provideHover(e,t,n){let r=e.uri;return this._worker(r).then(e=>e.doHover(r.toString(),J(t))).then(e=>{if(e)return{range:Y(e.range),contents:nr(e.contents)}})}};function er(e){return e&&typeof e==`object`&&typeof e.kind==`string`}function tr(e){return typeof e==`string`?{value:e}:er(e)?e.kind===`plaintext`?{value:e.value.replace(/[\\`*_{}[\]()#+\-.!]/g,`\\$&`)}:{value:e.value}:{value:"```"+e.language+`
`+e.value+"\n```\n"}}function nr(e){if(e)return Array.isArray(e)?e.map(tr):[tr(e)]}var rr=class{constructor(e){this._worker=e}provideDocumentHighlights(e,t,n){let r=e.uri;return this._worker(r).then(e=>e.findDocumentHighlights(r.toString(),J(t))).then(e=>{if(e)return e.map(e=>({range:Y(e.range),kind:ir(e.kind)}))})}};function ir(e){switch(e){case G.Read:return t.DocumentHighlightKind.Read;case G.Write:return t.DocumentHighlightKind.Write;case G.Text:return t.DocumentHighlightKind.Text}return t.DocumentHighlightKind.Text}var ar=class{constructor(e){this._worker=e}provideDefinition(e,t,n){let r=e.uri;return this._worker(r).then(e=>e.findDefinition(r.toString(),J(t))).then(e=>{if(e)return[or(e)]})}};function or(t){return{uri:e.parse(t.uri),range:Y(t.range)}}var sr=class{constructor(e){this._worker=e}provideReferences(e,t,n,r){let i=e.uri;return this._worker(i).then(e=>e.findReferences(i.toString(),J(t))).then(e=>{if(e)return e.map(or)})}},cr=class{constructor(e){this._worker=e}provideRenameEdits(e,t,n,r){let i=e.uri;return this._worker(i).then(e=>e.doRename(i.toString(),J(t),n)).then(e=>lr(e))}};function lr(t){if(!t||!t.changes)return;let n=[];for(let r in t.changes){let i=e.parse(r);for(let e of t.changes[r])n.push({resource:i,versionId:void 0,textEdit:{range:Y(e.range),text:e.newText}})}return{edits:n}}var ur=class{constructor(e){this._worker=e}provideDocumentSymbols(e,t){let n=e.uri;return this._worker(n).then(e=>e.findDocumentSymbols(n.toString())).then(e=>{if(e)return e.map(e=>dr(e)?fr(e):{name:e.name,detail:``,containerName:e.containerName,kind:pr(e.kind),range:Y(e.location.range),selectionRange:Y(e.location.range),tags:[]})})}};function dr(e){return`children`in e}function fr(e){return{name:e.name,detail:e.detail??``,kind:pr(e.kind),range:Y(e.range),selectionRange:Y(e.selectionRange),tags:e.tags??[],children:(e.children??[]).map(e=>fr(e))}}function pr(e){let n=t.SymbolKind;switch(e){case K.File:return n.File;case K.Module:return n.Module;case K.Namespace:return n.Namespace;case K.Package:return n.Package;case K.Class:return n.Class;case K.Method:return n.Method;case K.Property:return n.Property;case K.Field:return n.Field;case K.Constructor:return n.Constructor;case K.Enum:return n.Enum;case K.Interface:return n.Interface;case K.Function:return n.Function;case K.Variable:return n.Variable;case K.Constant:return n.Constant;case K.String:return n.String;case K.Number:return n.Number;case K.Boolean:return n.Boolean;case K.Array:return n.Array}return n.Function}var mr=class{constructor(e){this._worker=e}provideLinks(e,t){let n=e.uri;return this._worker(n).then(e=>e.findDocumentLinks(n.toString())).then(e=>{if(e)return{links:e.map(e=>({range:Y(e.range),url:e.target}))}})}},hr=class{constructor(e){this._worker=e}provideDocumentFormattingEdits(e,t,n){let r=e.uri;return this._worker(r).then(e=>e.format(r.toString(),null,_r(t)).then(e=>{if(!(!e||e.length===0))return e.map(X)}))}},gr=class{constructor(e){this._worker=e,this.canFormatMultipleRanges=!1}provideDocumentRangeFormattingEdits(e,t,n,r){let i=e.uri;return this._worker(i).then(e=>e.format(i.toString(),Yn(t),_r(n)).then(e=>{if(!(!e||e.length===0))return e.map(X)}))}};function _r(e){return{tabSize:e.tabSize,insertSpaces:e.insertSpaces}}var vr=class{constructor(e){this._worker=e}provideDocumentColors(e,t){let n=e.uri;return this._worker(n).then(e=>e.findDocumentColors(n.toString())).then(e=>{if(e)return e.map(e=>({color:e.color,range:Y(e.range)}))})}provideColorPresentations(e,t,n){let r=e.uri;return this._worker(r).then(e=>e.getColorPresentations(r.toString(),t.color,Yn(t.range))).then(e=>{if(e)return e.map(e=>{let t={label:e.label};return e.textEdit&&(t.textEdit=X(e.textEdit)),e.additionalTextEdits&&(t.additionalTextEdits=e.additionalTextEdits.map(X)),t})})}},yr=class{constructor(e){this._worker=e}provideFoldingRanges(e,t,n){let r=e.uri;return this._worker(r).then(e=>e.getFoldingRanges(r.toString(),t)).then(e=>{if(e)return e.map(e=>{let t={start:e.startLine+1,end:e.endLine+1};return e.kind!==void 0&&(t.kind=br(e.kind)),t})})}};function br(e){switch(e){case R.Comment:return t.FoldingRangeKind.Comment;case R.Imports:return t.FoldingRangeKind.Imports;case R.Region:return t.FoldingRangeKind.Region}}var xr=class{constructor(e){this._worker=e}provideSelectionRanges(e,t,n){let r=e.uri;return this._worker(r).then(e=>e.getSelectionRanges(r.toString(),t.map(J))).then(e=>{if(e)return e.map(e=>{let t=[];for(;e;)t.push({range:Y(e.range)}),e=e.parent;return t})})}},Sr=class extends Jn{constructor(e){super(e,[`.`,`:`,`<`,`"`,`=`,`/`])}};function Cr(e){let n=new F(e),r=(...e)=>n.getLanguageServiceWorker(...e),i=e.languageId;t.registerCompletionItemProvider(i,new Sr(r)),t.registerHoverProvider(i,new $n(r)),t.registerDocumentHighlightProvider(i,new rr(r)),t.registerLinkProvider(i,new mr(r)),t.registerFoldingRangeProvider(i,new yr(r)),t.registerDocumentSymbolProvider(i,new ur(r)),t.registerSelectionRangeProvider(i,new xr(r)),t.registerRenameProvider(i,new cr(r)),i===`html`&&(t.registerDocumentFormattingEditProvider(i,new hr(r)),t.registerDocumentRangeFormattingEditProvider(i,new gr(r)))}function wr(e){let n=[],r=[],i=new F(e);n.push(i);let a=(...e)=>i.getLanguageServiceWorker(...e);function o(){let{languageId:n,modeConfiguration:i}=e;Er(r),i.completionItems&&r.push(t.registerCompletionItemProvider(n,new Sr(a))),i.hovers&&r.push(t.registerHoverProvider(n,new $n(a))),i.documentHighlights&&r.push(t.registerDocumentHighlightProvider(n,new rr(a))),i.links&&r.push(t.registerLinkProvider(n,new mr(a))),i.documentSymbols&&r.push(t.registerDocumentSymbolProvider(n,new ur(a))),i.rename&&r.push(t.registerRenameProvider(n,new cr(a))),i.foldingRanges&&r.push(t.registerFoldingRangeProvider(n,new yr(a))),i.selectionRanges&&r.push(t.registerSelectionRangeProvider(n,new xr(a))),i.documentFormattingEdits&&r.push(t.registerDocumentFormattingEditProvider(n,new hr(a))),i.documentRangeFormattingEdits&&r.push(t.registerDocumentRangeFormattingEditProvider(n,new gr(a)))}return o(),n.push(Tr(r)),Tr(n)}function Tr(e){return{dispose:()=>Er(e)}}function Er(e){for(;e.length;)e.pop().dispose()}var Dr=new Set([`typescript`,`html`,`css`,`scss`,`less`,`stylus`,`sass`]),Z=null,Q=new WeakSet;function Or(){return this._client||=(async()=>(this._worker=u({moduleId:`vs/language/typescript/tsWorker`,createWorker:()=>new Worker(new URL(``+new URL(`monaco-angular.worker-CIX9hJp-.js`,import.meta.url).href,``+import.meta.url),{type:`module`}),label:this._modeId,keepIdleModels:!0,createData:{compilerOptions:this._defaults.getCompilerOptions(),extraLibs:this._defaults.getExtraLibs(),customWorkerPath:this._defaults.workerOptions.customWorkerPath,inlayHintsOptions:this._defaults.inlayHintsOptions}}),this._defaults.getEagerModelSync()?await this._worker.withSyncedResources(a.getModels().map(e=>e.uri)):await this._worker.getProxy()))(),this._client}function kr(...e){if(this._defaults.getCompilerOptions())return(async()=>{let t=await this._getClient();return this._worker&&(e.some(e=>String(e).endsWith(`.html`))?await this._worker.withSyncedResources(e):await Ar.call(this)),t})()}function Ar(){return this._worker.withSyncedResources(a.getModels().filter(e=>Dr.has(e.getLanguageId())).map(e=>e.uri))}function jr(e,t){if(!Q.has(e)){if(Q.add(e),e._worker&&=(e._worker.dispose(),null),e._defaults.getCompilerOptions){let n=e._defaults.getCompilerOptions;e._defaults.getCompilerOptions=function(){return{...n.call(this),angularConfig:t}}}e._client=null,Z=e}}function Mr(e){Q.has(e)||(Q.add(e),e._worker&&=(e._worker.dispose(),null),e._client=null,e._idleCheckInterval&&clearInterval(e._idleCheckInterval),e._configChangeListener&&e._configChangeListener.dispose())}function $(){return Z?Promise.resolve(Z):new Promise(e=>{let t=setInterval(()=>{Z&&(clearInterval(t),e(Z))},50)})}function Nr(e={strictTemplates:!0}){let t=JSON.parse(JSON.stringify(e)),n=Object.getOwnPropertyDescriptors(P.prototype),i=Object.getOwnPropertyDescriptors(F.prototype),o=[];P.prototype._getClient=function(){return jr(this,t),Or.call(this)},P.prototype.getLanguageServiceWorker=function(...e){return jr(this,t),kr.call(this,...e)},F.prototype._getClient=function(){return Mr(this),$().then(e=>e._getClient())},F.prototype.getLanguageServiceWorker=function(...e){return Mr(this),$().then(t=>t.getLanguageServiceWorker(...e))},F.prototype.dispose=function(){Mr(this)},F.prototype._stopWorker=function(){},F.prototype._checkIfIdle=function(){};let s=(...e)=>$().then(t=>t.getLanguageServiceWorker(...e)),c=new r,l=new Map,u=e=>{e.getLanguageId()===`html`||l.has(e.uri.toString())||l.set(e.uri.toString(),e.onDidChangeContent(()=>c.fire()))},d=e=>{let t=e.uri.toString();l.get(t)?.dispose(),l.delete(t)};return a.getModels().forEach(u),o.push(a.onDidCreateModel(u)),o.push(a.onWillDisposeModel(d)),o.push(a.onDidChangeModelLanguage(e=>{d(e.model),u(e.model)})),o.push(new Gn(`html`,s,e=>c.event(e))),o.push({dispose:()=>l.forEach(e=>e.dispose())}),()=>{Object.defineProperties(P.prototype,n),Object.defineProperties(F.prototype,i),o.forEach(e=>e.dispose()),Z=null}}var Pr=`/**
...
\r
/**\r
 * Used to shim class extends.\r
 *\r
 * @param d The derived class.\r
 * @param b The base class.\r
 */\r
 ...
 *\r
 * @param t The target object to copy to.\r
...
\r
/**\r
 * Performs a rest spread on an object.\r
 *\r
 * @param t The source value.\r
 * @param propertyNames The property names excluded from the rest spread.\r
 */\r
export declare function __rest(t: any, propertyNames: (string | symbol)[]): any;\r
\r
/**\r
 * Applies decorators to a target object\r
 *\r
 * @param decorators The set of decorators to apply.\r
 * @param target The target object.\r
 * @param key If specified, the own property to apply the decorators to.\r
 * @param desc The property descriptor, defaults to fetching the descriptor from the target object.\r
 * @experimental\r
 */\r
export declare function __decorate(decorators: Function[], target: any, key?: string | symbol, desc?: any): any;\r
\r
/**\r
 * Creates an observing function decorator from a parameter decorator.\r
 *\r
 * @param paramIndex The parameter index to apply the decorator to.\r
 * @param decorator The parameter decorator to apply. Note that the return value is ignored.\r
 * @experimental\r
 */\r
export declare function __param(paramIndex: number, decorator: Function): Function;\r
\r
/**\r
 * Applies decorators to a class or class member, following the native ECMAScript decorator specification.\r
 * @param ctor For non-field class members, the class constructor. Otherwise, \`null\`.\r
 * @param descriptorIn The \`PropertyDescriptor\` to use when unable to look up the property from \`ctor\`.\r
 * @param decorators The decorators to apply\r
 * @param contextIn The \`DecoratorContext\` to clone for each decorator application.\r
 * @param initializers An array of field initializer mutation functions into which new initializers are written.\r
 * @param extraInitializers An array of extra initializer functions into which new initializers are written.\r
 */\r
export declare function __esDecorate(ctor: Function | null, descriptorIn: object | null, decorators: Function[], contextIn: object, initializers: Function[] | null, extraInitializers: Function[]): void;\r
\r
/**\r
 * Runs field initializers or extra initializers generated by \`__esDecorate\`.\r
 * @param thisArg The \`this\` argument to use.\r
 * @param initializers The array of initializers to evaluate.\r
 * @param value The initial value to pass to the initializers.\r
 */\r
export declare function __runInitializers(thisArg: unknown, initializers: Function[], value?: any): any;\r
\r
/**\r
 * Converts a computed property name into a \`string\` or \`symbol\` value.\r
 */\r
export declare function __propKey(x: any): string | symbol;\r
\r
/**\r
 * Assigns the name of a function derived from the left-hand side of an assignment.\r
 * @param f The function to rename.\r
 * @param name The new name for the function.\r
 * @param prefix A prefix (such as \`"get"\` or \`"set"\`) to insert before the name.\r
 */\r
export declare function __setFunctionName(f: Function, name: string | symbol, prefix?: string): Function;\r
\r
/**\r
 * Creates a decorator that sets metadata.\r
 *\r
 * @param metadataKey The metadata key\r
 * @param metadataValue The metadata value\r
 * @experimental\r
 */\r
export declare function __metadata(metadataKey: any, metadataValue: any): Function;\r
\r
/**\r
 * Converts a generator function into a pseudo-async function, by treating each \`yield\` as an \`await\`.\r
 *\r
 * @param thisArg The reference to use as the \`this\` value in the generator function\r
 * @param _arguments The optional arguments array\r
 * @param P The optional promise constructor argument, defaults to the \`Promise\` property of the global object.\r
 * @param generator The generator function\r
 */\r
export declare function __awaiter(thisArg: any, _arguments: any, P: Function, generator: Function): any;\r
\r
/**\r
 * Creates an Iterator object using the body as the implementation.\r
 *\r
 * @param thisArg The reference to use as the \`this\` value in the function\r
 * @param body The generator state-machine based implementation.\r
 *\r
 * @see [./docs/generator.md]\r
 */\r
export declare function __generator(thisArg: any, body: Function): any;\r
\r
/**\r
 * Creates bindings for all enumerable properties of \`m\` on \`exports\`\r
 *\r
 * @param m The source object\r
 * @param o The \`exports\` object.\r
 */\r
export declare function __exportStar(m: any, o: any): void;\r
\r
/**\r
 * Creates a value iterator from an \`Iterable\` or \`ArrayLike\` object.\r
 *\r
 * @param o The object.\r
 * @throws {TypeError} If \`o\` is neither \`Iterable\`, nor an \`ArrayLike\`.\r
 */\r
export declare function __values(o: any): any;\r
\r
/**\r
 * Reads values from an \`Iterable\` or \`ArrayLike\` object and returns the resulting array.\r
 *\r
 * @param o The object to read from.\r
 * @param n The maximum number of arguments to read, defaults to \`Infinity\`.\r
 */\r
export declare function __read(o: any, n?: number): any[];\r
\r
/**\r
 * Creates an array from iterable spread.\r
 *\r
 * @param args The Iterable objects to spread.\r
 * @deprecated since TypeScript 4.2 - Use \`__spreadArray\`\r
 */\r
export declare function __spread(...args: any[][]): any[];\r
\r
/**\r
 * Creates an array from array spread.\r
 *\r
 * @param args The ArrayLikes to spread into the resulting array.\r
 * @deprecated since TypeScript 4.2 - Use \`__spreadArray\`\r
 */\r
export declare function __spreadArrays(...args: any[][]): any[];\r
\r
/**\r
 * Spreads the \`from\` array into the \`to\` array.\r
 *\r
 * @param pack Replace empty elements with \`undefined\`.\r
 */\r
export declare function __spreadArray(to: any[], from: any[], pack?: boolean): any[];\r
\r
/**\r
 * Creates an object that signals to \`__asyncGenerator\` that it shouldn't be yielded,\r
 * and instead should be awaited and the resulting value passed back to the generator.\r
 *\r
 * @param v The value to await.\r
 */\r
export declare function __await(v: any): any;\r
\r
/**\r
 * Converts a generator function into an async generator function, by using \`yield __await\`\r
 * in place of normal \`await\`.\r
 *\r
 * @param thisArg The reference to use as the \`this\` value in the generator function\r
 * @param _arguments The optional arguments array\r
 * @param generator The generator function\r
...
\r
/**\r
 * Used to wrap a potentially async iterator in such a way so that it wraps the result\r
 * of calling iterator methods of \`o\` in \`__await\` instances, and then yields the awaited values.\r
 *\r
 * @param o The potentially async iterator.\r
 * @returns A synchronous iterator yielding \`__await\` instances on every odd invocation\r
 *          and returning the awaited \`IteratorResult\` passed to \`next\` every even invocation.\r
 */\r
export declare function __asyncDelegator(o: any): any;\r
\r
/**\r
 * Creates a value async iterator from an \`AsyncIterable\`, \`Iterable\` or \`ArrayLike\` object.\r
 *\r
 * @param o The object.\r
 * @throws {TypeError} If \`o\` is neither \`AsyncIterable\`, \`Iterable\`, nor an \`ArrayLike\`.\r
 */\r
export declare function __asyncValues(o: any): any;\r
\r
/**\r
 * Creates a \`TemplateStringsArray\` frozen object from the \`cooked\` and \`raw\` arrays.\r
 *\r
 * @param cooked The cooked possibly-sparse array.\r
 * @param raw The raw string content.\r
 */\r
export declare function __makeTemplateObject(cooked: string[], raw: string[]): TemplateStringsArray;\r
\r
/**\r
 * Used to shim default and named imports in ECMAScript Modules transpiled to CommonJS.\r
 *\r
 * \`\`\`js\r
 * import Default, { Named, Other } from "mod";\r
 * // or\r
 * import { default as Default, Named, Other } from "mod";\r
 * \`\`\`\r
 *\r
 * @param mod The CommonJS module exports object.\r
 */\r
export declare function __importStar<T>(mod: T): T;\r
\r
/**\r
 * Used to shim default imports in ECMAScript Modules transpiled to CommonJS.\r
 *\r
 * \`\`\`js\r
 * import Default from "mod";\r
 * \`\`\`\r
 *\r
 * @param mod The CommonJS module exports object.\r
 */\r
...
\r
/**\r
 * Emulates reading a private instance field.\r
 *\r
 * @param receiver The instance from which to read the private field.\r
 * @param state A WeakMap containing the private field value for an instance.\r
 * @param kind Either \`"f"\` for a field, \`"a"\` for an accessor, or \`"m"\` for a method.\r
 *\r
 * @throws {TypeError} If \`state\` doesn't have an entry for \`receiver\`.\r
 */\r
...
\r
/**\r
 * Emulates reading a private static field.\r
 *\r
 * @param receiver The object from which to read the private static field.\r
 * @param state The class constructor containing the definition of the static field.\r
 * @param kind Either \`"f"\` for a field, \`"a"\` for an accessor, or \`"m"\` for a method.\r
 * @param f The descriptor that holds the static field value.\r
 *\r
 * @throws {TypeError} If \`receiver\` is not \`state\`.\r
 */\r
...
\r
/**\r
 * Emulates evaluating a private instance "get" accessor.\r
 *\r
 * @param receiver The instance on which to evaluate the private "get" accessor.\r
 * @param state A WeakSet used to verify an instance supports the private "get" accessor.\r
 * @param kind Either \`"f"\` for a field, \`"a"\` for an accessor, or \`"m"\` for a method.\r
 * @param f The "get" accessor function to evaluate.\r
 *\r
 * @throws {TypeError} If \`state\` doesn't have an entry for \`receiver\`.\r
 */\r
export declare function __classPrivateFieldGet<T extends object, V>(\r
...
\r
/**\r
 * Emulates evaluating a private static "get" accessor.\r
 *\r
 * @param receiver The object on which to evaluate the private static "get" accessor.\r
 * @param state The class constructor containing the definition of the static "get" accessor.\r
 * @param kind Either \`"f"\` for a field, \`"a"\` for an accessor, or \`"m"\` for a method.\r
 * @param f The "get" accessor function to evaluate.\r
 *\r
 * @throws {TypeError} If \`receiver\` is not \`state\`.\r
...
\r
/**\r
 * Emulates reading a private instance method.\r
 *\r
 * @param receiver The instance from which to read a private method.\r
 * @param state A WeakSet used to verify an instance supports the private method.\r
 * @param kind Either \`"f"\` for a field, \`"a"\` for an accessor, or \`"m"\` for a method.\r
 * @param f The function to return as the private instance method.\r
 *\r
 * @throws {TypeError} If \`state\` doesn't have an entry for \`receiver\`.\r
 */\r
...
\r
/**\r
 * Emulates reading a private static method.\r
 *\r
 * @param receiver The object from which to read the private static method.\r
 * @param state The class constructor containing the definition of the static method.\r
 * @param kind Either \`"f"\` for a field, \`"a"\` for an accessor, or \`"m"\` for a method.\r
 * @param f The function to return as the private static method.\r
 *\r
 * @throws {TypeError} If \`receiver\` is not \`state\`.\r
 */\r
...
\r
/**\r
 * Emulates writing to a private instance field.\r
 *\r
 * @param receiver The instance on which to set a private field value.\r
 * @param state A WeakMap used to store the private field value for an instance.\r
 * @param value The value to store in the private field.\r
 * @param kind Either \`"f"\` for a field, \`"a"\` for an accessor, or \`"m"\` for a method.\r
 *\r
 * @throws {TypeError} If \`state\` doesn't have an entry for \`receiver\`.\r
 */\r
...
\r
/**\r
 * Emulates writing to a private static field.\r
 *\r
 * @param receiver The object on which to set the private static field.\r
 * @param state The class constructor containing the definition of the private static field.\r
 * @param value The value to store in the private field.\r
 * @param kind Either \`"f"\` for a field, \`"a"\` for an accessor, or \`"m"\` for a method.\r
 * @param f The descriptor that holds the static field value.\r
 *\r
...
\r
/**\r
 * Emulates writing to a private instance "set" accessor.\r
 *\r
 * @param receiver The instance on which to evaluate the private instance "set" accessor.\r
 * @param state A WeakSet used to verify an instance supports the private "set" accessor.\r
 * @param value The value to store in the private accessor.\r
 * @param kind Either \`"f"\` for a field, \`"a"\` for an accessor, or \`"m"\` for a method.\r
 * @param f The "set" accessor function to evaluate.\r
 *\r
 * @throws {TypeError} If \`state\` doesn't have an entry for \`receiver\`.\r
 */\r
export declare function __classPrivateFieldSet<T extends object, V>(\r
...
\r
/**\r
 * Emulates writing to a private static "set" accessor.\r
 *\r
 * @param receiver The object on which to evaluate the private static "set" accessor.\r
 * @param state The class constructor containing the definition of the static "set" accessor.\r
 * @param value The value to store in the private field.\r
 * @param kind Either \`"f"\` for a field, \`"a"\` for an accessor, or \`"m"\` for a method.\r
 * @param f The "set" accessor function to evaluate.\r
 *\r
...
\r
/**\r
 * Checks for the existence of a private field/method/accessor.\r
 *\r
 * @param state The class constructor containing the static member, or the WeakMap or WeakSet associated with a private instance member.\r
 * @param receiver The object for which to test the presence of the private member.\r
 */\r
export declare function __classPrivateFieldIn(\r
    state: (new (...args: any[]) => unknown) | { has(o: any): boolean },\r
    receiver: unknown,\r
): boolean;\r
\r
/**\r
 * Creates a re-export binding on \`object\` with key \`objectKey\` that references \`target[key]\`.\r
 *\r
 * @param object The local \`exports\` object.\r
 * @param target The object to re-export from.\r
 * @param key The property key of \`target\` to re-export.\r
 * @param objectKey The property key to re-export as. Defaults to \`key\`.\r
 */\r
export declare function __createBinding(object: object, target: object, key: PropertyKey, objectKey?: PropertyKey): void;\r
\r
/**\r
 * Adds a disposable resource to a resource-tracking environment object.\r
 * @param env A resource-tracking environment object.\r
 * @param value Either a Disposable or AsyncDisposable object, \`null\`, or \`undefined\`.\r
 * @param async When \`true\`, \`AsyncDisposable\` resources can be added. When \`false\`, \`AsyncDisposable\` resources cannot be added.\r
 * @returns The {@link value} argument.\r
 *\r
 * @throws {TypeError} If {@link value} is not an object, or if either \`Symbol.dispose\` or \`Symbol.asyncDispose\` are not\r
 * defined, or if {@link value} does not have an appropriate \`Symbol.dispose\` or \`Symbol.asyncDispose\` method.\r
 */\r
export declare function __addDisposableResource<T>(env: { stack: { value?: unknown, dispose?: Function, async: boolean }[]; error: unknown; hasError: boolean; }, value: T, async: boolean): T;\r
\r
/**\r
 * Disposes all resources in a resource-tracking environment object.\r
 * @param env A resource-tracking environment object.\r
 * @returns A {@link Promise} if any resources in the environment were marked as \`async\` when added; otherwise, \`void\`.\r
 *\r
 * @throws {SuppressedError} if an error thrown during disposal would have suppressed a prior error from disposal or the\r
 * error recorded in the resource-tracking environment object.\r
 * @seealso {@link __addDisposableResource}\r
 */\r
export declare function __disposeResources(env: { stack: { value?: unknown, dispose?: Function, async: boolean }[]; error: unknown; hasError: boolean; }): any;\r
\r
/**\r
 * Transforms a relative import specifier ending in a non-declaration TypeScript file extension to its JavaScript file extension counterpart.\r
 * @param path The import specifier.\r
 * @param preserveJsx Causes '*.tsx' to transform to '*.jsx' instead of '*.js'. Should be true when \`--jsx\` is set to \`preserve\`.\r
 */\r
export declare function __rewriteRelativeImportExtension(path: string, preserveJsx?: boolean): string;`;function Jr(e){return new Worker(``+new URL(`editor.worker-DWlYVeeX.js`,import.meta.url).href,{name:e?.name})}function Yr(e){return new Worker(``+new URL(`css.worker-BtW9exzf.js`,import.meta.url).href,{name:e?.name})}function Xr(e){return new Worker(``+new URL(`monaco-angular.worker-CIX9hJp-.js`,import.meta.url).href,{name:e?.name})}var Zr=new Xr;self.MonacoEnvironment={getWorker(e,t){return t===`typescript`||t===`javascript`||t===`html`?Zr:t===`css`?new Yr:new Jr}};function Qr(t,n){let r=[];r.push({dispose:Nr()}),v.setCompilerOptions({target:ke.ESNext,module:Ee.ESNext,moduleResolution:Ae.NodeJs,experimentalDecorators:!0,emitDecoratorMetadata:!0,strict:!0,strictNullChecks:!0,strictPropertyInitialization:!1,noEmit:!0,noImplicitAny:!0,noImplicitReturns:!0,noFallthroughCasesInSwitch:!0,allowNonTsExtensions:!0,allowSyntheticDefaultImports:!0,esModuleInterop:!0,forceConsistentCasingInFileNames:!0,skipLibCheck:!0,sourceMap:!0,declaration:!1,downlevelIteration:!0,importHelpers:!0,useDefineForClassFields:!1,lib:[`es2022`,`dom`],baseUrl:`.`,paths:{"@angular/*":[`node_modules/@angular/core/*`]}}),r.push(v.addExtraLib(Pr,`file:///node_modules/@angular/core/index.d.ts`)),r.push(v.addExtraLib(Fr,`file:///node_modules/@angular/core/primitives-di.d.ts`)),r.push(v.addExtraLib(Ir,`file:///node_modules/@angular/core/primitives-event-dispatch.d.ts`)),r.push(v.addExtraLib(Lr,`file:///node_modules/@angular/core/primitives-signals.d.ts`)),r.push(v.addExtraLib(Rr,`file:///node_modules/@angular/core/rxjs-interop.d.ts`)),r.push(v.addExtraLib(zr,`file:///node_modules/@angular/core/testing.d.ts`)),r.push(v.addExtraLib(Br,`file:///node_modules/@angular/core/_api-chunk.d.ts`)),r.push(v.addExtraLib(Vr,`file:///node_modules/@angular/core/_chrome_dev_tools_performance-chunk.d.ts`)),r.push(v.addExtraLib(Hr,`file:///node_modules/@angular/core/_discovery-chunk.d.ts`)),r.push(v.addExtraLib(Ur,`file:///node_modules/@angular/core/_effect-chunk.d.ts`)),r.push(v.addExtraLib(Wr,`file:///node_modules/@angular/core/_event_dispatcher-chunk.d.ts`)),r.push(v.addExtraLib(Gr,`file:///node_modules/@angular/core/_formatter-chunk.d.ts`)),r.push(v.addExtraLib(Kr,`file:///node_modules/@angular/core/_weak_ref-chunk.d.ts`)),r.push(v.addExtraLib(`declare module 'tslib' { ${qr} }`,`file:///node_modules/tslib/index.d.ts`));let i=a.createModel(``,`typescript`,e.parse(`file:///app/app.ts`)),o=a.createModel(``,`html`,e.parse(`file:///app/app.html`));r.push(i),r.push(o);let s={theme:`vs-dark`,automaticLayout:!0,useShadowDOM:!0,scrollbar:{useShadows:!1,verticalScrollbarSize:10,horizontalScrollbarSize:10,verticalSliderSize:10,horizontalSliderSize:10},padding:{top:40,bottom:5},scrollBeyondLastLine:!1,minimap:{enabled:!1}},c=a.create(t,s),l=a.create(n,s);return r.push(c),r.push(l),c.setModel(o),l.setModel(i),{tsEditor:l,htmlEditor:c,getTsErrors:()=>a.getModelMarkers({resource:i.uri}),getHtmlErrors:()=>a.getModelMarkers({resource:o.uri}),dispose:()=>r.forEach(e=>e.dispose())}}var $r=document.getElementById(`html-editor`),ei=document.getElementById(`ts-editor`);if(!$r||!ei)throw Error(`Missing elements`);var{tsEditor:ti,htmlEditor:ni}=Qr($r,ei);ti.setValue(`import { Component } from '@angular/core';
...
export class HelloComponent {
    ...
    <h1>{{ title }}</h1>
    <h2>{{ subtitle }}</h2>
</div>`);export{v as C,P as S,J as _,Gn as a,X as b,rr as c,ur as d,yr as f,xr as g,cr as h,ar as i,mr as l,sr as m,Cr as n,vr as o,$n as p,Jn as r,hr as s,wr as t,gr as u,Yn as v,F as x,Y as y};